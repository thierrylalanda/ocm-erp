...
var Error500Component = class _Error500Component {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _Error500Component, selectors: [["app-error-500"]], decls: 20, vars: 1, consts: [[1, "bg-white", "coming-soon"], [1, "auth-bg"], [1, "container-fuild"], [1, "w-100", "overflow-hidden", "position-relative", "flex-wrap", "d-block", "vh-100"], [1, "row", "justify-content-center", "align-items-center", "vh-100", "overflow-auto", "flex-wrap"], [1, "col-lg-6"], [1, "d-flex", "flex-column", "align-items-center", "justify-content-center"], [1, "error-images", "mb-5"], ["src", "assets/img/error-500.svg", "alt", "image", 1, "img-fluid"], [1, "text-center"], [1, "mb-3", "fw-bold"], [1, "fs-16", "text-center"], [1, "d-flex", "justify-content-center", "pb-3"], [1, "btn", "btn-primary", "d-flex", "align-items-center", 3, "routerLink"], [1, "isax", "isax-arrow-left", "me-2"]], template: function Error500Component_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(13, "Server Error 500. We apologise and are fixing the problem ");
      \u0275\u0275element(14, "br");
      \u0275\u0275text(15, "Please try again at a later stage");
      \u0275\u0275elementEnd();
