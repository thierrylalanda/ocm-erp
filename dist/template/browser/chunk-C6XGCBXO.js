...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DeleteAccountRequestComponent, { className: "DeleteAccountRequestComponent", filePath: "src/app/features/manage/manage-users/delete-account-request/delete-account-request.component.ts", lineNumber: 19 });
})();
export {
  DeleteAccountRequestComponent
};
//# sourceMappingURL=chunk-C6XGCBXO.js.map
