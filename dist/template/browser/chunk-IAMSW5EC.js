...
} from "./chunk-PKEROVVW.js";
import {
  SettingsService
} from "./chunk-SWNP6CSU.js";
...
function ModulesComponent_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-side-menu-two");
  }
}
function ModulesComponent_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
...
var ModulesComponent = class _ModulesComponent {
  ...
  static \u0275fac = function ModulesComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _ModulesComponent)(\u0275\u0275directiveInject(SideBarService), \u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(DataService), \u0275\u0275directiveInject(CommonService), \u0275\u0275directiveInject(SettingsService), \u0275\u0275directiveInject(BreakpointObserver));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ModulesComponent, selectors: [["app-modules"]], decls: 20, vars: 28, consts: [[1, "main-wrapper", 3, "ngClass"], [3, "ngClass"], [1, "page-wrapper"], [1, "content", 3, "ngClass"], [1, "footer", "d-sm-flex", "align-items-center", "justify-content-between", "bg-white", "py-2", "px-4", "border-top"], [1, "text-title", "mb-0"], ["href", "javascript:void(0);", 1, "link-primary"], [1, "text-title"], [1, "sidebar-overlay", 3, "click", "ngClass"]], template: function ModulesComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0);
      \u0275\u0275element(1, "app-header-one", 1)(2, "app-side-menu-one", 1);
      \u0275\u0275conditionalCreate(3, ModulesComponent_Conditional_3_Template, 1, 0, "app-side-menu-two");
      \u0275\u0275conditionalCreate(4, ModulesComponent_Conditional_4_Template, 1, 0, "app-side-menu-three");
      ...
      \u0275\u0275listener("click", function ModulesComponent_Template_div_click_18_listener() {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ModulesComponent, [{
    type: Component,
    args: [{ selector: "app-modules", encapsulation: ViewEncapsulation.None, imports: [CommonModule, RouterModule, SideMenuThreeComponent, SideMenuTwoComponent, SideMenuOneComponent, HeaderOneComponent, LayoutComponent], template: `
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ModulesComponent, { className: "ModulesComponent", filePath: "src/app/modules/modules.ts", lineNumber: 30 });
})();
export {
  ModulesComponent
};
//# sourceMappingURL=chunk-IAMSW5EC.js.map
