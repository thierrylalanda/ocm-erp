...
// src/app/modules/setting/presentation/pages/other-settings/database-backup/database-backup.component.ts
var DatabaseBackupComponent = class _DatabaseBackupComponent {
  static \u0275fac = function DatabaseBackupComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _DatabaseBackupComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DatabaseBackupComponent, selectors: [["app-database-backup"]], decls: 111, vars: 0, consts: [[1, ""], [1, "pb-3", "border-bottom", "mb-3"], [1, "mb-0"], [1, "row", "justify-content-between", "align-items-center", "pb-1"], [1, "col-md-5", "mb-3"], [1, "input-icon-start", "position-relative"], [1, "input-icon-addon"], [1, "isax", "isax-search-normal"], ["type", "text", "placeholder", "Search", 1, "form-control", "form-control-sm", "bg-white"], [1, "col-md-7", "text-end", "mb-3"], ["href", "javascript:void(0);", "data-bs-toggle", "modal", "data-bs-target", "#generate_modal", 1, "btn", "btn-primary", "d-inline-flex", "align-items-center"], [1, "isax", "isax-folder-connection5", "me-1"], [1, "table-responsive", "table-nowrap"], [1, "table", "border", "dataTable"], [1, "table-light"], [1, "no-sort"], [1, "text-dark"], [1, "action-item"], ["href", "javascript:void(0);", "data-bs-toggle", "dropdown"], [1, "isax", "isax-more"], [1, "dropdown-menu"], ["href", "javascript:void(0);", "data-bs-toggle", "modal", "data-bs-target", "#delete_modal", 1, "dropdown-item", "d-flex", "align-items-center"], [1, "isax", "isax-trash", "me-2"], ["id", "generate_modal", 1, "modal", "fade"], [1, "modal-dialog", "modal-dialog-centered", "modal-sm"], [1, "modal-content"], [1, "modal-body", "text-center"], [1, "mb-3"], [1, "isax", "isax-folder-24", "fs-48", "text-primary", "fw-normal"], [1, "mb-1"], [1, "d-flex", "justify-content-center"], ["href", "javascript:void(0);", "data-bs-dismiss", "modal", 1, "btn", "btn-outline-white", "me-3"], ["href", "javascript:void(0);", "data-bs-dismiss", "modal", 1, "btn", "btn-primary"], ["id", "delete_modal", 1, "modal", "fade"], ["src", "assets/img/icons/delete.svg", "alt", "img"]], template: function DatabaseBackupComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275domElementStart(0, "div", 0)(1, "div")(2, "div", 1)(3, "h6", 2);
      \u0275\u0275text(4, "Database Backup");
      \u0275\u0275domElementEnd()();
      ...
      \u0275\u0275text(28, "sales_db_backup_20250312.sql");
      \u0275\u0275domElementEnd()();
      ...
      \u0275\u0275text(42, "invoice_db_backup_2025-03-12_1430.sql");
      \u0275\u0275domElementEnd()();
      ...
      \u0275\u0275text(56, "customer_db_backup_2025-03-12.sql");
      \u0275\u0275domElementEnd()();
      ...
      \u0275\u0275text(70, "full_backup_2025-03-12.sql");
      \u0275\u0275domElementEnd()();
      ...
      \u0275\u0275text(103, "Delete Databse");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(104, "p", 27);
      \u0275\u0275text(105, "Are you sure, you want to delete Databse?");
      \u0275\u0275domElementEnd();
