...
var import_file_saver, FileSaverService, FileSaverDirective, FileSaverModule;
var init_ngx_filesaver = __esm({
  "node_modules/ngx-filesaver/fesm2020/ngx-filesaver.mjs"() {
    "use strict";
    init_core();
    init_core();
    import_file_saver = __toESM(require_FileSaver_min(), 1);
    init_http();
    init_http();
    FileSaverService = class {
    ...
    FileSaverService.\u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "14.0.3", ngImport: core_exports, type: FileSaverService, deps: [], target: FactoryTarget.Injectable });
    FileSaverService.\u0275prov = \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "14.0.3", ngImport: core_exports, type: FileSaverService, providedIn: "root" });
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.3", ngImport: core_exports, type: FileSaverService, decorators: [{
      type: Injectable,
      args: [{ providedIn: "root" }]
    }] });
    FileSaverDirective = class {
    ...
    FileSaverDirective.\u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "14.0.3", ngImport: core_exports, type: FileSaverDirective, deps: [{ token: ElementRef }, { token: FileSaverService }, { token: HttpClient }], target: FactoryTarget.Directive });
    FileSaverDirective.\u0275dir = \u0275\u0275ngDeclareDirective({ minVersion: "14.0.0", version: "14.0.3", type: FileSaverDirective, isStandalone: true, selector: "[fileSaver]", inputs: { method: "method", http: "http", query: "query", header: "header", url: "url", fileName: "fileName", fsOptions: "fsOptions" }, outputs: { success: "success", error: "error" }, host: { listeners: { "click": "_click()" } }, exportAs: ["fileSaver"], ngImport: core_exports });
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.3", ngImport: core_exports, type: FileSaverDirective, decorators: [{
      type: Directive,
      args: [{
        selector: "[fileSaver]",
        exportAs: "fileSaver",
      ...
      return [{ type: ElementRef }, { type: FileSaverService }, { type: HttpClient }];
    ...
    FileSaverModule.\u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "14.0.3", ngImport: core_exports, type: FileSaverModule, deps: [], target: FactoryTarget.NgModule });
    FileSaverModule.\u0275mod = \u0275\u0275ngDeclareNgModule({ minVersion: "14.0.0", version: "14.0.3", ngImport: core_exports, type: FileSaverModule, imports: [FileSaverDirective], exports: [FileSaverDirective] });
    FileSaverModule.\u0275inj = \u0275\u0275ngDeclareInjector({ minVersion: "12.0.0", version: "14.0.3", ngImport: core_exports, type: FileSaverModule });
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.3", ngImport: core_exports, type: FileSaverModule, decorators: [{
      type: NgModule,
      args: [{
...
var LIGHTBOX_EVENT, LightboxEvent, LightboxWindowRef;
var init_lightbox_event_service = __esm({
  "node_modules/ngx-lightbox/lightbox-event.service.js"() {
    "use strict";
    init_esm();
    init_core();
    ...
    LightboxEvent.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: LightboxEvent, factory: LightboxEvent.\u0275fac });
    (function() {
    ...
    LightboxWindowRef.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: LightboxWindowRef, factory: LightboxWindowRef.\u0275fac });
    (function() {
...
var _c0, _c1, _c2, _c3, _c4, _c5, _c6, _c7, _c8, _c9, LightboxComponent;
var init_lightbox_component = __esm({
  "node_modules/ngx-lightbox/lightbox.component.js"() {
    "use strict";
    init_common();
    init_core();
    init_lightbox_event_service();
    init_core();
    init_lightbox_event_service();
    init_ngx_filesaver();
    init_platform_browser();
    ...
    LightboxComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: LightboxComponent, selectors: [["", "lb-content", ""]], viewQuery: function LightboxComponent_Query(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275viewQuery(_c0, 5);
        \u0275\u0275viewQuery(_c1, 5);
        \u0275\u0275viewQuery(_c2, 5);
...
var LightboxConfig;
var init_lightbox_config_service = __esm({
  "node_modules/ngx-lightbox/lightbox-config.service.js"() {
    "use strict";
    init_core();
    init_core();
    LightboxConfig = class {
      constructor() {
    ...
    LightboxConfig.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: LightboxConfig, factory: LightboxConfig.\u0275fac });
    (function() {
...
var _c02, LightboxOverlayComponent;
var init_lightbox_overlay_component = __esm({
  "node_modules/ngx-lightbox/lightbox-overlay.component.js"() {
    "use strict";
    init_common();
    init_core();
    ...
    init_lightbox_event_service();
    _c02 = ["lb-overlay", ""];
    LightboxOverlayComponent = class {
    ...
    LightboxOverlayComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: LightboxOverlayComponent, selectors: [["", "lb-overlay", ""]], hostVars: 2, hostBindings: function LightboxOverlayComponent_HostBindings(rf, ctx) {
      if (rf & 1) {
...
var Lightbox;
var init_lightbox_service = __esm({
  "node_modules/ngx-lightbox/lightbox.service.js"() {
    "use strict";
    init_core();
    init_lightbox_component();
    init_lightbox_config_service();
    init_lightbox_event_service();
    init_lightbox_overlay_component();
    init_common();
    init_core();
    init_lightbox_config_service();
    init_lightbox_event_service();
    ...
    Lightbox.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: Lightbox, factory: Lightbox.\u0275fac });
    (function() {
...
var LightboxModule;
var init_lightbox_module = __esm({
  "node_modules/ngx-lightbox/lightbox.module.js"() {
    "use strict";
    init_ngx_filesaver();
    init_core();
    ...
    init_lightbox_overlay_component();
    init_lightbox_component();
    init_lightbox_service();
    init_core();
    LightboxModule = class {
    };
    LightboxModule.\u0275fac = function LightboxModule_Factory(t) {
      return new (t || LightboxModule)();
    };
    LightboxModule.\u0275mod = /* @__PURE__ */ \u0275\u0275defineNgModule({ type: LightboxModule });
    LightboxModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ providers: [
      Lightbox,
      LightboxConfig,
      LightboxEvent,
      LightboxWindowRef
    ...
    (function() {
      \u0275\u0275setNgModuleScope(LightboxModule, { declarations: [LightboxOverlayComponent, LightboxComponent], imports: [FileSaverModule] });
    })();
  }
});

// node_modules/ngx-lightbox/index.js
var init_ngx_lightbox = __esm({
  "node_modules/ngx-lightbox/index.js"() {
    "use strict";
    init_lightbox_service();
    init_lightbox_config_service();
    init_lightbox_event_service();
    init_lightbox_module();
  }
});
...
//# sourceMappingURL=chunk-O22VSTEP.js.map
