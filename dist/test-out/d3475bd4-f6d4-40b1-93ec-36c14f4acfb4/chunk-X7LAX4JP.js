...
var LabelType, Options, AllowUnsafeHtmlInSlider, PointerType, ChangeContext, ValueHelper, CompatibilityHelper, MathHelper, EventListener, EventListenerHelper, SliderElementDirective, SliderHandleDirective, SliderLabelDirective, TooltipWrapperComponent, Tick, Dragging, ModelValues, ModelChange, NGX_SLIDER_CONTROL_VALUE_ACCESSOR, SliderComponent, NgxSliderModule;
var init_angular_slider_ngx_slider = __esm({
  "node_modules/@angular-slider/ngx-slider/fesm2022/angular-slider-ngx-slider.mjs"() {
    "use strict";
    init_core();
    init_core();
    ...
    init_esm();
    init_operators();
    init_detect_passive_events_esm();
    (function(LabelType2) {
    ...
    AllowUnsafeHtmlInSlider = new InjectionToken("AllowUnsafeHtmlInSlider");
    ...
    EventListenerHelper = class {
      ...
      attachPassiveEventListener(nativeElement, eventName, callback, throttleInterval) {
        ...
        listener.eventsSubscription = listener.events.pipe(
          !ValueHelper.isNullOrUndefined(throttleInterval) ? throttleTime(throttleInterval, void 0, { leading: true, trailing: true }) : tap(() => {
          })
          // no-op
        ).subscribe((event) => {
          callback(event);
    ...
    SliderElementDirective = class _SliderElementDirective {
      ...
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.0.4", ngImport: core_exports, type: _SliderElementDirective, deps: [], target: FactoryTarget.Directive });
      static \u0275dir = \u0275\u0275ngDeclareDirective({ minVersion: "14.0.0", version: "20.0.4", type: _SliderElementDirective, isStandalone: false, selector: "[ngxSliderElement]", host: { properties: { "style.opacity": "this.opacity", "style.visibility": "this.visibility", "style.left": "this.left", "style.bottom": "this.bottom", "style.height": "this.height", "style.width": "this.width", "style.transform": "this.transform" } }, ngImport: core_exports });
    };
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.0.4", ngImport: core_exports, type: SliderElementDirective, decorators: [{
      type: Directive,
      args: [{
    ...
    SliderHandleDirective = class _SliderHandleDirective extends SliderElementDirective {
      active = false;
      role = "";
      tabindex = "";
      ariaOrientation = "";
      ...
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.0.4", ngImport: core_exports, type: _SliderHandleDirective, deps: null, target: FactoryTarget.Directive });
      static \u0275dir = \u0275\u0275ngDeclareDirective({ minVersion: "14.0.0", version: "20.0.4", type: _SliderHandleDirective, isStandalone: false, selector: "[ngxSliderHandle]", host: { properties: { "class.ngx-slider-active": "this.active", "attr.role": "this.role", "attr.tabindex": "this.tabindex", "attr.aria-orientation": "this.ariaOrientation", "attr.aria-label": "this.ariaLabel", "attr.aria-labelledby": "this.ariaLabelledBy", "attr.aria-valuenow": "this.ariaValueNow", "attr.aria-valuetext": "this.ariaValueText", "attr.aria-valuemin": "this.ariaValueMin", "attr.aria-valuemax": "this.ariaValueMax" } }, usesInheritance: true, ngImport: core_exports });
    };
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.0.4", ngImport: core_exports, type: SliderHandleDirective, decorators: [{
      type: Directive,
      args: [{
    ...
    SliderLabelDirective = class _SliderLabelDirective extends SliderElementDirective {
      ...
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.0.4", ngImport: core_exports, type: _SliderLabelDirective, deps: null, target: FactoryTarget.Directive });
      static \u0275dir = \u0275\u0275ngDeclareDirective({ minVersion: "14.0.0", version: "20.0.4", type: _SliderLabelDirective, isStandalone: false, selector: "[ngxSliderLabel]", usesInheritance: true, ngImport: core_exports });
    };
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.0.4", ngImport: core_exports, type: SliderLabelDirective, decorators: [{
      type: Directive,
      args: [{
    ...
    TooltipWrapperComponent = class _TooltipWrapperComponent {
      template;
      tooltip;
      placement;
      content;
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.0.4", ngImport: core_exports, type: _TooltipWrapperComponent, deps: [], target: FactoryTarget.Component });
      static \u0275cmp = \u0275\u0275ngDeclareComponent({ minVersion: "17.0.0", version: "20.0.4", type: _TooltipWrapperComponent, isStandalone: false, selector: "ngx-slider-tooltip-wrapper", inputs: { template: "template", tooltip: "tooltip", placement: "placement", content: "content" }, ngImport: core_exports, template: '@if (template) {\n  <ng-template *ngTemplateOutlet="template; context: {tooltip: tooltip, placement: placement, content: content}"></ng-template>\n}\n\n@if (!template) {\n  <div class="ngx-slider-inner-tooltip" [attr.title]="tooltip" [attr.data-tooltip-placement]="placement">\n    {{content}}\n  </div>\n}', styles: [".ngx-slider-inner-tooltip{height:100%}\n"], dependencies: [{ kind: "directive", type: NgTemplateOutlet, selector: "[ngTemplateOutlet]", inputs: ["ngTemplateOutletContext", "ngTemplateOutlet", "ngTemplateOutletInjector"] }] });
    };
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.0.4", ngImport: core_exports, type: TooltipWrapperComponent, decorators: [{
      type: Component,
    ...
    ModelChange = class extends ModelValues {
    ...
    SliderComponent = class _SliderComponent {
      renderer = inject(Renderer2);
      ...
      getOptionsInfluencingEventBindings(options2) {
        return [
          options2.disabled,
          options2.readOnly,
          options2.draggableRange,
          options2.draggableRangeOnly,
          options2.onlyBindHandles,
          options2.keyboardSupport
        ];
      }
...
<span ngxSliderElement #ticksElement [hidden]="!showTicks" [class.ngx-slider-ticks-values-under]="ticksUnderValuesClass" class="ngx-slider-ticks">
  @for (t of ticks; track t) {
    ...
    NgxSliderModule = class _NgxSliderModule {
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.0.4", ngImport: core_exports, type: _NgxSliderModule, deps: [], target: FactoryTarget.NgModule });
      static \u0275mod = \u0275\u0275ngDeclareNgModule({ minVersion: "14.0.0", version: "20.0.4", ngImport: core_exports, type: _NgxSliderModule, declarations: [
        SliderComponent,
        SliderElementDirective,
        SliderHandleDirective,
        SliderLabelDirective,
        TooltipWrapperComponent
      ], imports: [CommonModule], exports: [SliderComponent] });
      static \u0275inj = \u0275\u0275ngDeclareInjector({ minVersion: "12.0.0", version: "20.0.4", ngImport: core_exports, type: _NgxSliderModule, imports: [CommonModule] });
    };
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.0.4", ngImport: core_exports, type: NgxSliderModule, decorators: [{
      type: NgModule,
      args: [{
        imports: [
          CommonModule
...
//# sourceMappingURL=chunk-X7LAX4JP.js.map
