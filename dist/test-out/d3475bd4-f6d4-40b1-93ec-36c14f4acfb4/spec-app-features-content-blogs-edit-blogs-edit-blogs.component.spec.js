...
var init_edit_blogs_component3 = __esm({
  "src/app/features/content/blogs/edit-blogs/edit-blogs.component.ts"() {
    ...
    init_select();
    init_router();
    EditBlogsComponent = class EditBlogsComponent2 {
      routes = routes;
      editor;
      toolbar = [
    ...
    EditBlogsComponent = __decorate([
      Component({
        ...
        template: edit_blogs_component_default,
        styles: [edit_blogs_component_default2]
      })
    ], EditBlogsComponent);
  }
});

// src/app/features/content/blogs/edit-blogs/edit-blogs.component.spec.ts
var require_edit_blogs_component_spec = __commonJS({
  "src/app/features/content/blogs/edit-blogs/edit-blogs.component.spec.ts"(exports) {
    init_testing();
    init_edit_blogs_component3();
...
export default require_edit_blogs_component_spec();
//# sourceMappingURL=spec-app-features-content-blogs-edit-blogs-edit-blogs.component.spec.js.map
