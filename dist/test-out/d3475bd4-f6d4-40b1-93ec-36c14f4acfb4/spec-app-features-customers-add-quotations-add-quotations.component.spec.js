...
// angular:jit:template:src/app/features/customers/add-quotations/add-quotations.component.html
var add_quotations_component_default;
var init_add_quotations_component = __esm({
  "angular:jit:template:src/app/features/customers/add-quotations/add-quotations.component.html"() {
    add_quotations_component_default = `  <!-- start row -->
  <div class="row">
...
// angular:jit:style:src/app/features/customers/add-quotations/add-quotations.component.scss
var add_quotations_component_default2;
var init_add_quotations_component2 = __esm({
  "angular:jit:style:src/app/features/customers/add-quotations/add-quotations.component.scss"() {
    add_quotations_component_default2 = "/* src/app/features/customers/add-quotations/add-quotations.component.scss */\n/*# sourceMappingURL=add-quotations.component.css.map */\n";
  }
});

// src/app/features/customers/add-quotations/add-quotations.component.ts
var AddQuotationsComponent;
var init_add_quotations_component3 = __esm({
  "src/app/features/customers/add-quotations/add-quotations.component.ts"() {
    "use strict";
    init_tslib_es6();
    init_add_quotations_component();
    init_add_quotations_component2();
    init_core();
    init_core_index();
    init_common();
    init_slider();
    ...
    init_select();
    init_router();
    AddQuotationsComponent = class AddQuotationsComponent2 {
      routes = routes;
      trash = false;
      formData = [];
      isTrash() {
    ...
    AddQuotationsComponent = __decorate([
      Component({
        ...
        template: add_quotations_component_default,
        styles: [add_quotations_component_default2]
      })
    ], AddQuotationsComponent);
  }
});

// src/app/features/customers/add-quotations/add-quotations.component.spec.ts
var require_add_quotations_component_spec = __commonJS({
  "src/app/features/customers/add-quotations/add-quotations.component.spec.ts"(exports) {
    init_testing();
    init_add_quotations_component3();
...
export default require_add_quotations_component_spec();
//# sourceMappingURL=spec-app-features-customers-add-quotations-add-quotations.component.spec.js.map
