...
// angular:jit:template:src/app/features/customers/invoice-report/invoice-report.component.html
var invoice_report_component_default;
var init_invoice_report_component = __esm({
  "angular:jit:template:src/app/features/customers/invoice-report/invoice-report.component.html"() {
    invoice_report_component_default = `<!-- Start Content -->
...
// angular:jit:style:src/app/features/customers/invoice-report/invoice-report.component.scss
var invoice_report_component_default2;
var init_invoice_report_component2 = __esm({
  "angular:jit:style:src/app/features/customers/invoice-report/invoice-report.component.scss"() {
    invoice_report_component_default2 = "/* src/app/features/customers/invoice-report/invoice-report.component.scss */\n/*# sourceMappingURL=invoice-report.component.css.map */\n";
  }
});

// src/app/features/customers/invoice-report/invoice-report.component.ts
var InvoiceReportComponent;
var init_invoice_report_component3 = __esm({
  "src/app/features/customers/invoice-report/invoice-report.component.ts"() {
    "use strict";
    init_tslib_es6();
    init_invoice_report_component();
    init_invoice_report_component2();
    init_core();
    init_sort();
    init_table();
    init_router();
    ...
    init_custom_pagination_component();
    init_forms();
    InvoiceReportComponent = class InvoiceReportComponent2 {
      data;
      router;
      pagination;
      routes = routes;
    ...
    InvoiceReportComponent = __decorate([
      Component({
        ...
        template: invoice_report_component_default,
        styles: [invoice_report_component_default2]
      })
    ], InvoiceReportComponent);
  }
});

// src/app/features/customers/invoice-report/invoice-report.component.spec.ts
var require_invoice_report_component_spec = __commonJS({
  "src/app/features/customers/invoice-report/invoice-report.component.spec.ts"(exports) {
    init_testing();
    init_invoice_report_component3();
...
export default require_invoice_report_component_spec();
//# sourceMappingURL=spec-app-features-customers-invoice-report-invoice-report.component.spec.js.map
