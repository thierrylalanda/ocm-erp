...
// angular:jit:template:src/app/features/customers/transactions/transactions.component.html
var transactions_component_default;
var init_transactions_component = __esm({
  "angular:jit:template:src/app/features/customers/transactions/transactions.component.html"() {
    transactions_component_default = `<!-- Start Content -->
...
// angular:jit:style:src/app/features/customers/transactions/transactions.component.scss
var transactions_component_default2;
var init_transactions_component2 = __esm({
  "angular:jit:style:src/app/features/customers/transactions/transactions.component.scss"() {
    transactions_component_default2 = "/* src/app/features/customers/transactions/transactions.component.scss */\n/*# sourceMappingURL=transactions.component.css.map */\n";
  }
});

// src/app/features/customers/transactions/transactions.component.ts
var TransactionsComponent;
var init_transactions_component3 = __esm({
  "src/app/features/customers/transactions/transactions.component.ts"() {
    "use strict";
    init_tslib_es6();
    init_transactions_component();
    init_transactions_component2();
    init_core();
    init_sort();
    init_table();
    init_router();
    ...
    init_slider();
    init_date_range_picker_component();
    TransactionsComponent = class TransactionsComponent2 {
      data;
      router;
      pagination;
      routes = routes;
    ...
    TransactionsComponent = __decorate([
      Component({
        ...
        template: transactions_component_default,
        styles: [transactions_component_default2]
      })
    ], TransactionsComponent);
  }
});

// src/app/features/customers/transactions/transactions.component.spec.ts
var require_transactions_component_spec = __commonJS({
  "src/app/features/customers/transactions/transactions.component.spec.ts"(exports) {
    init_testing();
    init_transactions_component3();
...
export default require_transactions_component_spec();
//# sourceMappingURL=spec-app-features-customers-transactions-transactions.component.spec.js.map
