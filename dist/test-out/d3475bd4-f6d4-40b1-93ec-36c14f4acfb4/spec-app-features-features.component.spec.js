...
// angular:jit:template:src/app/features/features.component.html
var features_component_default;
var init_features_component = __esm({
  "angular:jit:template:src/app/features/features.component.html"() {
    features_component_default = `
...
// angular:jit:style:src/app/features/features.component.scss
var features_component_default2;
var init_features_component2 = __esm({
  "angular:jit:style:src/app/features/features.component.scss"() {
    features_component_default2 = "/* src/app/features/features.component.scss */\n/*# sourceMappingURL=features.component.css.map */\n";
  }
});

// src/app/features/features.component.ts
var FeaturesComponent;
var init_features_component3 = __esm({
  "src/app/features/features.component.ts"() {
    "use strict";
    init_tslib_es6();
    init_features_component();
    init_features_component2();
    init_core();
    init_router();
    init_layout();
    init_core_index();
    ...
    init_header_one_component();
    init_layout_component();
    FeaturesComponent = class FeaturesComponent2 {
      sideBar;
      router;
      data;
      common;
    ...
    FeaturesComponent = __decorate([
      Component({
        ...
        template: features_component_default,
        ...
        styles: [features_component_default2]
      })
    ], FeaturesComponent);
  }
});

// src/app/features/features.component.spec.ts
var require_features_component_spec = __commonJS({
  "src/app/features/features.component.spec.ts"(exports) {
    init_testing();
    init_features_component3();
...
export default require_features_component_spec();
//# sourceMappingURL=spec-app-features-features.component.spec.js.map
