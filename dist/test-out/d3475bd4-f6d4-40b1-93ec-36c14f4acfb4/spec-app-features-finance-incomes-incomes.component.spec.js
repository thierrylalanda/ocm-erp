...
// angular:jit:template:src/app/features/finance/incomes/incomes.component.html
var incomes_component_default;
var init_incomes_component = __esm({
  "angular:jit:template:src/app/features/finance/incomes/incomes.component.html"() {
    incomes_component_default = `<!-- Start Content -->
...
// angular:jit:style:src/app/features/finance/incomes/incomes.component.scss
var incomes_component_default2;
var init_incomes_component2 = __esm({
  "angular:jit:style:src/app/features/finance/incomes/incomes.component.scss"() {
    incomes_component_default2 = "/* src/app/features/finance/incomes/incomes.component.scss */\n/*# sourceMappingURL=incomes.component.css.map */\n";
  }
});

// src/app/features/finance/incomes/incomes.component.ts
var IncomesComponent;
var init_incomes_component3 = __esm({
  "src/app/features/finance/incomes/incomes.component.ts"() {
    "use strict";
    init_tslib_es6();
    init_incomes_component();
    init_incomes_component2();
    init_core();
    init_sort();
    init_table();
    init_router();
    ...
    init_select();
    init_ngx_bootstrap_datepicker();
    IncomesComponent = class IncomesComponent2 {
      data;
      router;
      pagination;
      routes = routes;
    ...
    IncomesComponent = __decorate([
      Component({
        ...
        template: incomes_component_default,
        styles: [incomes_component_default2]
      })
    ], IncomesComponent);
  }
});

// src/app/features/finance/incomes/incomes.component.spec.ts
var require_incomes_component_spec = __commonJS({
  "src/app/features/finance/incomes/incomes.component.spec.ts"(exports) {
    init_testing();
    init_incomes_component3();
...
export default require_incomes_component_spec();
//# sourceMappingURL=spec-app-features-finance-incomes-incomes.component.spec.js.map
