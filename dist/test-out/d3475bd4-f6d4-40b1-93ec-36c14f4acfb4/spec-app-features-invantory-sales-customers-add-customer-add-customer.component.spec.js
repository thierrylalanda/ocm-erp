  ...
  "src/app/features/invantory-sales/customers/add-customer/add-customer.component.ts"() {
    ...
    AddCustomerComponent = __decorate([
      Component({
        ...
        template: add_customer_component_default,
        styles: [add_customer_component_default2]
      })
    ], AddCustomerComponent);
  }
});

// src/app/features/invantory-sales/customers/add-customer/add-customer.component.spec.ts
var require_add_customer_component_spec = __commonJS({
  "src/app/features/invantory-sales/customers/add-customer/add-customer.component.spec.ts"(exports) {
    init_testing();
    init_add_customer_component3();
...
export default require_add_customer_component_spec();
//# sourceMappingURL=spec-app-features-invantory-sales-customers-add-customer-add-customer.component.spec.js.map
