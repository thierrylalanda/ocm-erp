...
// angular:jit:template:src/app/features/invantory-sales/customers/customer-list/customer-list.component.html
var customer_list_component_default;
var init_customer_list_component = __esm({
  "angular:jit:template:src/app/features/invantory-sales/customers/customer-list/customer-list.component.html"() {
    customer_list_component_default = `<!-- Start Container -->
...
// angular:jit:style:src/app/features/invantory-sales/customers/customer-list/customer-list.component.scss
var customer_list_component_default2;
var init_customer_list_component2 = __esm({
  "angular:jit:style:src/app/features/invantory-sales/customers/customer-list/customer-list.component.scss"() {
    customer_list_component_default2 = "/* src/app/features/invantory-sales/customers/customer-list/customer-list.component.scss */\n/*# sourceMappingURL=customer-list.component.css.map */\n";
  }
});

// src/app/features/invantory-sales/customers/customer-list/customer-list.component.ts
var CustomerListComponent;
var init_customer_list_component3 = __esm({
  "src/app/features/invantory-sales/customers/customer-list/customer-list.component.ts"() {
    "use strict";
    init_tslib_es6();
    init_customer_list_component();
    init_customer_list_component2();
    init_core();
    init_sort();
    init_table();
    init_router();
    ...
    init_common();
    init_forms();
    CustomerListComponent = class CustomerListComponent2 {
      data;
      router;
      pagination;
      routes = routes;
    ...
    CustomerListComponent = __decorate([
      Component({
        ...
        imports: [MatSliderModule, DateRangePickerComponent, CustomPaginationComponent, MatSortModule, RouterLink, CommonModule, FormsModule],
        template: customer_list_component_default,
        styles: [customer_list_component_default2]
      })
    ], CustomerListComponent);
  }
});

// src/app/features/invantory-sales/customers/customer-list/customer-list.component.spec.ts
var require_customer_list_component_spec = __commonJS({
  "src/app/features/invantory-sales/customers/customer-list/customer-list.component.spec.ts"(exports) {
    init_testing();
    init_customer_list_component3();
...
export default require_customer_list_component_spec();
//# sourceMappingURL=spec-app-features-invantory-sales-customers-customer-list-customer-list.component.spec.js.map
