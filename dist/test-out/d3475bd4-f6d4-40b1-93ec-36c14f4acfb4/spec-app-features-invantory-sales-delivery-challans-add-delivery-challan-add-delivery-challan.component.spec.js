...
// angular:jit:template:src/app/features/invantory-sales/delivery-challans/add-delivery-challan/add-delivery-challan.component.html
var add_delivery_challan_component_default;
var init_add_delivery_challan_component = __esm({
  "angular:jit:template:src/app/features/invantory-sales/delivery-challans/add-delivery-challan/add-delivery-challan.component.html"() {
    add_delivery_challan_component_default = `  <!-- start row -->
  <div class="row">
...
// angular:jit:style:src/app/features/invantory-sales/delivery-challans/add-delivery-challan/add-delivery-challan.component.scss
var add_delivery_challan_component_default2;
var init_add_delivery_challan_component2 = __esm({
  "angular:jit:style:src/app/features/invantory-sales/delivery-challans/add-delivery-challan/add-delivery-challan.component.scss"() {
    add_delivery_challan_component_default2 = "/* src/app/features/invantory-sales/delivery-challans/add-delivery-challan/add-delivery-challan.component.scss */\n/*# sourceMappingURL=add-delivery-challan.component.css.map */\n";
  }
});

// src/app/features/invantory-sales/delivery-challans/add-delivery-challan/add-delivery-challan.component.ts
var AddDeliveryChallanComponent;
var init_add_delivery_challan_component3 = __esm({
  "src/app/features/invantory-sales/delivery-challans/add-delivery-challan/add-delivery-challan.component.ts"() {
    "use strict";
    init_tslib_es6();
    init_add_delivery_challan_component();
    init_add_delivery_challan_component2();
    init_core();
    init_core_index();
    init_select();
    init_common();
    init_router();
    init_ngx_bootstrap_datepicker();
    AddDeliveryChallanComponent = class AddDeliveryChallanComponent2 {
      routes = routes;
      trash = false;
      isTrash() {
        this.trash = true;
    ...
    AddDeliveryChallanComponent = __decorate([
      Component({
        selector: "app-add-delivery-challan",
        imports: [MatSelectModule, CommonModule, RouterLink, BsDatepickerModule],
        template: add_delivery_challan_component_default,
        styles: [add_delivery_challan_component_default2]
      })
    ], AddDeliveryChallanComponent);
  }
});

// src/app/features/invantory-sales/delivery-challans/add-delivery-challan/add-delivery-challan.component.spec.ts
var require_add_delivery_challan_component_spec = __commonJS({
  "src/app/features/invantory-sales/delivery-challans/add-delivery-challan/add-delivery-challan.component.spec.ts"(exports) {
    init_testing();
    init_add_delivery_challan_component3();
...
export default require_add_delivery_challan_component_spec();
//# sourceMappingURL=spec-app-features-invantory-sales-delivery-challans-add-delivery-challan-add-delivery-challan.component.spec.js.map
