...
// angular:jit:template:src/app/features/invantory-sales/delivery-challans/edit-delivery-challan/edit-delivery-challan.component.html
var edit_delivery_challan_component_default;
var init_edit_delivery_challan_component = __esm({
  "angular:jit:template:src/app/features/invantory-sales/delivery-challans/edit-delivery-challan/edit-delivery-challan.component.html"() {
    edit_delivery_challan_component_default = `<!-- start row -->
<div class="row">
...
// angular:jit:style:src/app/features/invantory-sales/delivery-challans/edit-delivery-challan/edit-delivery-challan.component.scss
var edit_delivery_challan_component_default2;
var init_edit_delivery_challan_component2 = __esm({
  "angular:jit:style:src/app/features/invantory-sales/delivery-challans/edit-delivery-challan/edit-delivery-challan.component.scss"() {
    edit_delivery_challan_component_default2 = "/* src/app/features/invantory-sales/delivery-challans/edit-delivery-challan/edit-delivery-challan.component.scss */\n/*# sourceMappingURL=edit-delivery-challan.component.css.map */\n";
  }
});

// src/app/features/invantory-sales/delivery-challans/edit-delivery-challan/edit-delivery-challan.component.ts
var EditDeliveryChallanComponent;
var init_edit_delivery_challan_component3 = __esm({
  "src/app/features/invantory-sales/delivery-challans/edit-delivery-challan/edit-delivery-challan.component.ts"() {
    "use strict";
    init_tslib_es6();
    init_edit_delivery_challan_component();
    init_edit_delivery_challan_component2();
    init_core();
    init_core_index();
    init_select();
    init_ngx_bootstrap_datepicker();
    ...
    init_forms();
    init_router();
    EditDeliveryChallanComponent = class EditDeliveryChallanComponent2 {
      routes = routes;
      trash = false;
      isTrash() {
        this.trash = true;
    ...
    EditDeliveryChallanComponent = __decorate([
      Component({
        selector: "app-edit-delivery-challan",
        imports: [MatSelectModule, BsDatepickerModule, CommonModule, FormsModule, RouterLink],
        template: edit_delivery_challan_component_default,
        styles: [edit_delivery_challan_component_default2]
      })
    ], EditDeliveryChallanComponent);
  }
});

// src/app/features/invantory-sales/delivery-challans/edit-delivery-challan/edit-delivery-challan.component.spec.ts
var require_edit_delivery_challan_component_spec = __commonJS({
  "src/app/features/invantory-sales/delivery-challans/edit-delivery-challan/edit-delivery-challan.component.spec.ts"(exports) {
    init_testing();
    init_edit_delivery_challan_component3();
...
export default require_edit_delivery_challan_component_spec();
//# sourceMappingURL=spec-app-features-invantory-sales-delivery-challans-edit-delivery-challan-edit-delivery-challan.component.spec.js.map
