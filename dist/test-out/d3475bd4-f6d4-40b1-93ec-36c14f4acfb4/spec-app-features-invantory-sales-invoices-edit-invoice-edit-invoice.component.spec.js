...
// angular:jit:template:src/app/features/invantory-sales/invoices/edit-invoice/edit-invoice.component.html
var edit_invoice_component_default;
var init_edit_invoice_component = __esm({
  "angular:jit:template:src/app/features/invantory-sales/invoices/edit-invoice/edit-invoice.component.html"() {
    edit_invoice_component_default = ` <!-- start row -->
 <div class="row">
...
// angular:jit:style:src/app/features/invantory-sales/invoices/edit-invoice/edit-invoice.component.scss
var edit_invoice_component_default2;
var init_edit_invoice_component2 = __esm({
  "angular:jit:style:src/app/features/invantory-sales/invoices/edit-invoice/edit-invoice.component.scss"() {
    edit_invoice_component_default2 = "/* src/app/features/invantory-sales/invoices/edit-invoice/edit-invoice.component.scss */\n/*# sourceMappingURL=edit-invoice.component.css.map */\n";
  }
});

// src/app/features/invantory-sales/invoices/edit-invoice/edit-invoice.component.ts
var EditInvoiceComponent;
var init_edit_invoice_component3 = __esm({
  "src/app/features/invantory-sales/invoices/edit-invoice/edit-invoice.component.ts"() {
    "use strict";
    init_tslib_es6();
    init_edit_invoice_component();
    init_edit_invoice_component2();
    init_core();
    init_core_index();
    init_select();
    init_ngx_bootstrap_datepicker();
    init_common();
    init_router();
    EditInvoiceComponent = class EditInvoiceComponent2 {
      routes = routes;
      trash = true;
      isTrash() {
        this.trash = false;
    ...
    EditInvoiceComponent = __decorate([
      Component({
        selector: "app-edit-invoice",
        template: edit_invoice_component_default,
        imports: [MatSelectModule, BsDatepickerModule, CommonModule, RouterLink],
        styles: [edit_invoice_component_default2]
      })
    ], EditInvoiceComponent);
  }
});

// src/app/features/invantory-sales/invoices/edit-invoice/edit-invoice.component.spec.ts
var require_edit_invoice_component_spec = __commonJS({
  "src/app/features/invantory-sales/invoices/edit-invoice/edit-invoice.component.spec.ts"(exports) {
    init_testing();
    init_edit_invoice_component3();
...
export default require_edit_invoice_component_spec();
//# sourceMappingURL=spec-app-features-invantory-sales-invoices-edit-invoice-edit-invoice.component.spec.js.map
