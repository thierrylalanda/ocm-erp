...
// angular:jit:template:src/app/features/invantory-sales/invoices/recurring-invoices/recurring-invoices.component.html
var recurring_invoices_component_default;
var init_recurring_invoices_component = __esm({
  "angular:jit:template:src/app/features/invantory-sales/invoices/recurring-invoices/recurring-invoices.component.html"() {
    recurring_invoices_component_default = `			<!-- Start Container -->
...
// angular:jit:style:src/app/features/invantory-sales/invoices/recurring-invoices/recurring-invoices.component.scss
var recurring_invoices_component_default2;
var init_recurring_invoices_component2 = __esm({
  "angular:jit:style:src/app/features/invantory-sales/invoices/recurring-invoices/recurring-invoices.component.scss"() {
    recurring_invoices_component_default2 = "/* src/app/features/invantory-sales/invoices/recurring-invoices/recurring-invoices.component.scss */\n/*# sourceMappingURL=recurring-invoices.component.css.map */\n";
  }
});

// src/app/features/invantory-sales/invoices/recurring-invoices/recurring-invoices.component.ts
var RecurringInvoicesComponent;
var init_recurring_invoices_component3 = __esm({
  "src/app/features/invantory-sales/invoices/recurring-invoices/recurring-invoices.component.ts"() {
    "use strict";
    init_tslib_es6();
    init_recurring_invoices_component();
    init_recurring_invoices_component2();
    init_core();
    init_sort();
    init_table();
    init_router();
    ...
    init_common();
    init_forms();
    RecurringInvoicesComponent = class RecurringInvoicesComponent2 {
      data;
      router;
      pagination;
      routes = routes;
    ...
    RecurringInvoicesComponent = __decorate([
      Component({
        selector: "app-recurring-invoices",
        template: recurring_invoices_component_default,
        imports: [
          MatSliderModule,
          DateRangePickerComponent,
          CustomPaginationComponent,
        ...
        styles: [recurring_invoices_component_default2]
      })
    ], RecurringInvoicesComponent);
  }
});

// src/app/features/invantory-sales/invoices/recurring-invoices/recurring-invoices.component.spec.ts
var require_recurring_invoices_component_spec = __commonJS({
  "src/app/features/invantory-sales/invoices/recurring-invoices/recurring-invoices.component.spec.ts"(exports) {
    init_testing();
    init_recurring_invoices_component3();
...
export default require_recurring_invoices_component_spec();
//# sourceMappingURL=spec-app-features-invantory-sales-invoices-recurring-invoices-recurring-invoices.component.spec.js.map
