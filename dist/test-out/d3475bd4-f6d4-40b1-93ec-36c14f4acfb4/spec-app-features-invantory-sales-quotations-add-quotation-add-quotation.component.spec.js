...
// angular:jit:template:src/app/features/invantory-sales/quotations/add-quotation/add-quotation.component.html
var add_quotation_component_default;
var init_add_quotation_component = __esm({
  "angular:jit:template:src/app/features/invantory-sales/quotations/add-quotation/add-quotation.component.html"() {
    add_quotation_component_default = `  <!-- start row -->
  <div class="row">
...
// angular:jit:style:src/app/features/invantory-sales/quotations/add-quotation/add-quotation.component.scss
var add_quotation_component_default2;
var init_add_quotation_component2 = __esm({
  "angular:jit:style:src/app/features/invantory-sales/quotations/add-quotation/add-quotation.component.scss"() {
    add_quotation_component_default2 = "/* src/app/features/invantory-sales/quotations/add-quotation/add-quotation.component.scss */\n/*# sourceMappingURL=add-quotation.component.css.map */\n";
  }
});

// src/app/features/invantory-sales/quotations/add-quotation/add-quotation.component.ts
var AddQuotationComponent;
var init_add_quotation_component3 = __esm({
  "src/app/features/invantory-sales/quotations/add-quotation/add-quotation.component.ts"() {
    "use strict";
    init_tslib_es6();
    init_add_quotation_component();
    init_add_quotation_component2();
    init_core();
    init_core_index();
    init_ngx_bootstrap_datepicker();
    init_select();
    init_common();
    init_router();
    AddQuotationComponent = class AddQuotationComponent2 {
      routes = routes;
      trash = false;
      formData = [];
      isTrash() {
    ...
    AddQuotationComponent = __decorate([
      Component({
        selector: "app-add-quotation",
        template: add_quotation_component_default,
        imports: [BsDatepickerModule, MatSelectModule, CommonModule, RouterLink],
        styles: [add_quotation_component_default2]
      })
    ], AddQuotationComponent);
  }
});

// src/app/features/invantory-sales/quotations/add-quotation/add-quotation.component.spec.ts
var require_add_quotation_component_spec = __commonJS({
  "src/app/features/invantory-sales/quotations/add-quotation/add-quotation.component.spec.ts"(exports) {
    init_testing();
    init_add_quotation_component3();
...
export default require_add_quotation_component_spec();
//# sourceMappingURL=spec-app-features-invantory-sales-quotations-add-quotation-add-quotation.component.spec.js.map
