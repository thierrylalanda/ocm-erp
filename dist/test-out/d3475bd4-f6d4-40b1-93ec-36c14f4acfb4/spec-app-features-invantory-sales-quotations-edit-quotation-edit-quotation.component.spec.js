...
// angular:jit:template:src/app/features/invantory-sales/quotations/edit-quotation/edit-quotation.component.html
var edit_quotation_component_default;
var init_edit_quotation_component = __esm({
  "angular:jit:template:src/app/features/invantory-sales/quotations/edit-quotation/edit-quotation.component.html"() {
    edit_quotation_component_default = `<!-- start row -->
<div class="row">
...
// angular:jit:style:src/app/features/invantory-sales/quotations/edit-quotation/edit-quotation.component.scss
var edit_quotation_component_default2;
var init_edit_quotation_component2 = __esm({
  "angular:jit:style:src/app/features/invantory-sales/quotations/edit-quotation/edit-quotation.component.scss"() {
    edit_quotation_component_default2 = "/* src/app/features/invantory-sales/quotations/edit-quotation/edit-quotation.component.scss */\n/*# sourceMappingURL=edit-quotation.component.css.map */\n";
  }
});

// src/app/features/invantory-sales/quotations/edit-quotation/edit-quotation.component.ts
var EditQuotationComponent;
var init_edit_quotation_component3 = __esm({
  "src/app/features/invantory-sales/quotations/edit-quotation/edit-quotation.component.ts"() {
    "use strict";
    init_tslib_es6();
    init_edit_quotation_component();
    init_edit_quotation_component2();
    init_core();
    init_core_index();
    init_select();
    init_common();
    init_router();
    init_ngx_bootstrap_datepicker();
    EditQuotationComponent = class EditQuotationComponent2 {
      routes = routes;
      trash = false;
      formData = [];
      isTrash() {
    ...
    EditQuotationComponent = __decorate([
      Component({
        ...
        template: edit_quotation_component_default,
        imports: [BsDatepickerModule, MatSelectModule, CommonModule, RouterLink],
        styles: [edit_quotation_component_default2]
      })
    ], EditQuotationComponent);
  }
});

// src/app/features/invantory-sales/quotations/edit-quotation/edit-quotation.component.spec.ts
var require_edit_quotation_component_spec = __commonJS({
  "src/app/features/invantory-sales/quotations/edit-quotation/edit-quotation.component.spec.ts"(exports) {
    init_testing();
    init_edit_quotation_component3();
...
export default require_edit_quotation_component_spec();
//# sourceMappingURL=spec-app-features-invantory-sales-quotations-edit-quotation-edit-quotation.component.spec.js.map
