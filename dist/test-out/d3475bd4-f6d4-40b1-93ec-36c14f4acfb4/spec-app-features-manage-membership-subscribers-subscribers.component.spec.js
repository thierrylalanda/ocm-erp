...
// angular:jit:template:src/app/features/manage/membership/subscribers/subscribers.component.html
var subscribers_component_default;
var init_subscribers_component = __esm({
  "angular:jit:template:src/app/features/manage/membership/subscribers/subscribers.component.html"() {
    subscribers_component_default = `<div class="content-two">
...
// angular:jit:style:src/app/features/manage/membership/subscribers/subscribers.component.scss
var subscribers_component_default2;
var init_subscribers_component2 = __esm({
  "angular:jit:style:src/app/features/manage/membership/subscribers/subscribers.component.scss"() {
    subscribers_component_default2 = "/* src/app/features/manage/membership/subscribers/subscribers.component.scss */\n/*# sourceMappingURL=subscribers.component.css.map */\n";
  }
});

// src/app/features/manage/membership/subscribers/subscribers.component.ts
var SubscribersComponent;
var init_subscribers_component3 = __esm({
  "src/app/features/manage/membership/subscribers/subscribers.component.ts"() {
    "use strict";
    init_tslib_es6();
    init_subscribers_component();
    init_subscribers_component2();
    init_core();
    init_sort();
    init_table();
    init_router();
    ...
    init_forms();
    init_slider();
    SubscribersComponent = class SubscribersComponent2 {
      data;
      router;
      pagination;
      routes = routes;
    ...
    SubscribersComponent = __decorate([
      Component({
        ...
        imports: [DateRangePickerComponent, CustomPaginationComponent, CommonModule, MatSelectModule, MatSortModule, FormsModule, MatSliderModule],
        template: subscribers_component_default,
        styles: [subscribers_component_default2]
      })
    ], SubscribersComponent);
  }
});

// src/app/features/manage/membership/subscribers/subscribers.component.spec.ts
var require_subscribers_component_spec = __commonJS({
  "src/app/features/manage/membership/subscribers/subscribers.component.spec.ts"(exports) {
    init_testing();
    init_subscribers_component3();
...
export default require_subscribers_component_spec();
//# sourceMappingURL=spec-app-features-manage-membership-subscribers-subscribers.component.spec.js.map
