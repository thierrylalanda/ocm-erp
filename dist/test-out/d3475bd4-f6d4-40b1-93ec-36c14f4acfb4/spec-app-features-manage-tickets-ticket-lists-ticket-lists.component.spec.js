...
// angular:jit:template:src/app/features/manage/tickets/ticket-lists/ticket-lists.component.html
var ticket_lists_component_default;
var init_ticket_lists_component = __esm({
  "angular:jit:template:src/app/features/manage/tickets/ticket-lists/ticket-lists.component.html"() {
    ticket_lists_component_default = `            <!-- Start Content -->
...
// angular:jit:style:src/app/features/manage/tickets/ticket-lists/ticket-lists.component.scss
var ticket_lists_component_default2;
var init_ticket_lists_component2 = __esm({
  "angular:jit:style:src/app/features/manage/tickets/ticket-lists/ticket-lists.component.scss"() {
    ticket_lists_component_default2 = "/* src/app/features/manage/tickets/ticket-lists/ticket-lists.component.scss */\n/*# sourceMappingURL=ticket-lists.component.css.map */\n";
  }
});

// src/app/features/manage/tickets/ticket-lists/ticket-lists.component.ts
var TicketListsComponent;
var init_ticket_lists_component3 = __esm({
  "src/app/features/manage/tickets/ticket-lists/ticket-lists.component.ts"() {
    "use strict";
    init_tslib_es6();
    init_ticket_lists_component();
    init_ticket_lists_component2();
    init_core();
    init_sort();
    init_table();
    init_router();
    ...
    init_forms();
    init_ngx_bootstrap_datepicker();
    TicketListsComponent = class TicketListsComponent2 {
      data;
      router;
      pagination;
      routes = routes;
    ...
    TicketListsComponent = __decorate([
      Component({
        selector: "app-ticket-lists",
        imports: [MatSelectModule, DateRangePickerComponent, CustomPaginationComponent, RouterLink, CommonModule, FormsModule, MatSortModule, BsDatepickerModule],
        template: ticket_lists_component_default,
        styles: [ticket_lists_component_default2]
      })
    ], TicketListsComponent);
  }
});

// src/app/features/manage/tickets/ticket-lists/ticket-lists.component.spec.ts
var require_ticket_lists_component_spec = __commonJS({
  "src/app/features/manage/tickets/ticket-lists/ticket-lists.component.spec.ts"(exports) {
    init_testing();
    init_ticket_lists_component3();
...
export default require_ticket_lists_component_spec();
//# sourceMappingURL=spec-app-features-manage-tickets-ticket-lists-ticket-lists.component.spec.js.map
