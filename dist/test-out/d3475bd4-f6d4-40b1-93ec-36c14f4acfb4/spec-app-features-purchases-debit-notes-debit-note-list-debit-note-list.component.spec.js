...
// angular:jit:template:src/app/features/purchases/debit-notes/debit-note-list/debit-note-list.component.html
var debit_note_list_component_default;
var init_debit_note_list_component = __esm({
  "angular:jit:template:src/app/features/purchases/debit-notes/debit-note-list/debit-note-list.component.html"() {
    debit_note_list_component_default = `			<!-- Start Content -->
...
// angular:jit:style:src/app/features/purchases/debit-notes/debit-note-list/debit-note-list.component.scss
var debit_note_list_component_default2;
var init_debit_note_list_component2 = __esm({
  "angular:jit:style:src/app/features/purchases/debit-notes/debit-note-list/debit-note-list.component.scss"() {
    debit_note_list_component_default2 = "/* src/app/features/purchases/debit-notes/debit-note-list/debit-note-list.component.scss */\n/*# sourceMappingURL=debit-note-list.component.css.map */\n";
  }
});

// src/app/features/purchases/debit-notes/debit-note-list/debit-note-list.component.ts
var DebitNoteListComponent;
var init_debit_note_list_component3 = __esm({
  "src/app/features/purchases/debit-notes/debit-note-list/debit-note-list.component.ts"() {
    "use strict";
    init_tslib_es6();
    init_debit_note_list_component();
    init_debit_note_list_component2();
    init_core();
    init_sort();
    init_table();
    init_router();
    ...
    init_forms();
    init_custom_pagination_component();
    DebitNoteListComponent = class DebitNoteListComponent2 {
      data;
      router;
      pagination;
      routes = routes;
    ...
    DebitNoteListComponent = __decorate([
      Component({
        ...
        template: debit_note_list_component_default,
        styles: [debit_note_list_component_default2]
      })
    ], DebitNoteListComponent);
  }
});

// src/app/features/purchases/debit-notes/debit-note-list/debit-note-list.component.spec.ts
var require_debit_note_list_component_spec = __commonJS({
  "src/app/features/purchases/debit-notes/debit-note-list/debit-note-list.component.spec.ts"(exports) {
    init_testing();
    init_debit_note_list_component3();
...
export default require_debit_note_list_component_spec();
//# sourceMappingURL=spec-app-features-purchases-debit-notes-debit-note-list-debit-note-list.component.spec.js.map
