...
// angular:jit:template:src/app/features/purchases/purchase-orders/purchases-order-list/purchases-order-list.component.html
var purchases_order_list_component_default;
var init_purchases_order_list_component = __esm({
  "angular:jit:template:src/app/features/purchases/purchase-orders/purchases-order-list/purchases-order-list.component.html"() {
    purchases_order_list_component_default = `<!-- Start Content -->
...
// angular:jit:style:src/app/features/purchases/purchase-orders/purchases-order-list/purchases-order-list.component.scss
var purchases_order_list_component_default2;
var init_purchases_order_list_component2 = __esm({
  "angular:jit:style:src/app/features/purchases/purchase-orders/purchases-order-list/purchases-order-list.component.scss"() {
    purchases_order_list_component_default2 = "/* src/app/features/purchases/purchase-orders/purchases-order-list/purchases-order-list.component.scss */\n/*# sourceMappingURL=purchases-order-list.component.css.map */\n";
  }
});

// src/app/features/purchases/purchase-orders/purchases-order-list/purchases-order-list.component.ts
var PurchasesOrderListComponent;
var init_purchases_order_list_component3 = __esm({
  "src/app/features/purchases/purchase-orders/purchases-order-list/purchases-order-list.component.ts"() {
    "use strict";
    init_tslib_es6();
    init_purchases_order_list_component();
    init_purchases_order_list_component2();
    init_core();
    init_sort();
    init_table();
    init_router();
    ...
    init_common();
    init_forms();
    PurchasesOrderListComponent = class PurchasesOrderListComponent2 {
      data;
      router;
      pagination;
      routes = routes;
    ...
    PurchasesOrderListComponent = __decorate([
      Component({
        ...
        template: purchases_order_list_component_default,
        styles: [purchases_order_list_component_default2]
      })
    ], PurchasesOrderListComponent);
  }
});

// src/app/features/purchases/purchase-orders/purchases-order-list/purchases-order-list.component.spec.ts
var require_purchases_order_list_component_spec = __commonJS({
  "src/app/features/purchases/purchase-orders/purchases-order-list/purchases-order-list.component.spec.ts"(exports) {
    init_testing();
    init_purchases_order_list_component3();
...
export default require_purchases_order_list_component_spec();
//# sourceMappingURL=spec-app-features-purchases-purchase-orders-purchases-order-list-purchases-order-list.component.spec.js.map
