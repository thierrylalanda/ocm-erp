...
// angular:jit:template:src/app/features/reports/accounting-report/expense-report/expense-report.component.html
var expense_report_component_default;
var init_expense_report_component = __esm({
  "angular:jit:template:src/app/features/reports/accounting-report/expense-report/expense-report.component.html"() {
    expense_report_component_default = ` <!-- Start Content -->
...
// angular:jit:style:src/app/features/reports/accounting-report/expense-report/expense-report.component.scss
var expense_report_component_default2;
var init_expense_report_component2 = __esm({
  "angular:jit:style:src/app/features/reports/accounting-report/expense-report/expense-report.component.scss"() {
    expense_report_component_default2 = "/* src/app/features/reports/accounting-report/expense-report/expense-report.component.scss */\n/*# sourceMappingURL=expense-report.component.css.map */\n";
  }
});

// src/app/features/reports/accounting-report/expense-report/expense-report.component.ts
var ExpenseReportComponent;
var init_expense_report_component3 = __esm({
  "src/app/features/reports/accounting-report/expense-report/expense-report.component.ts"() {
    "use strict";
    init_tslib_es6();
    init_expense_report_component();
    init_expense_report_component2();
    init_core();
    init_sort();
    init_table();
    init_router();
    ...
    init_date_range_picker_component();
    init_slider();
    ExpenseReportComponent = class ExpenseReportComponent2 {
      data;
      router;
      pagination;
      routes = routes;
    ...
    ExpenseReportComponent = __decorate([
      Component({
        ...
        template: expense_report_component_default,
        styles: [expense_report_component_default2]
      })
    ], ExpenseReportComponent);
  }
});

// src/app/features/reports/accounting-report/expense-report/expense-report.component.spec.ts
var require_expense_report_component_spec = __commonJS({
  "src/app/features/reports/accounting-report/expense-report/expense-report.component.spec.ts"(exports) {
    init_testing();
    init_expense_report_component3();
...
export default require_expense_report_component_spec();
//# sourceMappingURL=spec-app-features-reports-accounting-report-expense-report-expense-report.component.spec.js.map
