...
var init_trial_balance_component3 = __esm({
  "src/app/features/reports/accounting-report/trial-balance/trial-balance.component.ts"() {
    ...
    init_date_range_picker_2_component();
    init_slider();
    TrialBalanceComponent = class TrialBalanceComponent2 {
      data;
      router;
      pagination;
      routes = routes;
    ...
    TrialBalanceComponent = __decorate([
      Component({
        ...
        template: trial_balance_component_default,
        styles: [trial_balance_component_default2]
      })
    ], TrialBalanceComponent);
  }
});

// src/app/features/reports/accounting-report/trial-balance/trial-balance.component.spec.ts
var require_trial_balance_component_spec = __commonJS({
  "src/app/features/reports/accounting-report/trial-balance/trial-balance.component.spec.ts"(exports) {
    init_testing();
    init_trial_balance_component3();
...
export default require_trial_balance_component_spec();
//# sourceMappingURL=spec-app-features-reports-accounting-report-trial-balance-trial-balance.component.spec.js.map
