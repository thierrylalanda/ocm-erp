...
// angular:jit:template:src/app/features/reports/finance-reports/payment-summary/payment-summary.component.html
var payment_summary_component_default;
var init_payment_summary_component = __esm({
  "angular:jit:template:src/app/features/reports/finance-reports/payment-summary/payment-summary.component.html"() {
    payment_summary_component_default = `			<!-- Start conatiner -->
...
// angular:jit:style:src/app/features/reports/finance-reports/payment-summary/payment-summary.component.scss
var payment_summary_component_default2;
var init_payment_summary_component2 = __esm({
  "angular:jit:style:src/app/features/reports/finance-reports/payment-summary/payment-summary.component.scss"() {
    payment_summary_component_default2 = "/* src/app/features/reports/finance-reports/payment-summary/payment-summary.component.scss */\n/*# sourceMappingURL=payment-summary.component.css.map */\n";
  }
});

// src/app/features/reports/finance-reports/payment-summary/payment-summary.component.ts
var PaymentSummaryComponent;
var init_payment_summary_component3 = __esm({
  "src/app/features/reports/finance-reports/payment-summary/payment-summary.component.ts"() {
    "use strict";
    init_tslib_es6();
    init_payment_summary_component();
    init_payment_summary_component2();
    init_core();
    init_sort();
    init_table();
    init_router();
    ...
    init_date_range_picker_component();
    init_date_range_picker_2_component();
    PaymentSummaryComponent = class PaymentSummaryComponent2 {
      data;
      router;
      pagination;
      routes = routes;
    ...
    PaymentSummaryComponent = __decorate([
      Component({
        ...
        template: payment_summary_component_default,
        styles: [payment_summary_component_default2]
      })
    ], PaymentSummaryComponent);
  }
});

// src/app/features/reports/finance-reports/payment-summary/payment-summary.component.spec.ts
var require_payment_summary_component_spec = __commonJS({
  "src/app/features/reports/finance-reports/payment-summary/payment-summary.component.spec.ts"(exports) {
    init_testing();
    init_payment_summary_component3();
...
export default require_payment_summary_component_spec();
//# sourceMappingURL=spec-app-features-reports-finance-reports-payment-summary-payment-summary.component.spec.js.map
