...
// angular:jit:template:src/app/features/reports/item-report/sold-stock/sold-stock.component.html
var sold_stock_component_default;
var init_sold_stock_component = __esm({
  "angular:jit:template:src/app/features/reports/item-report/sold-stock/sold-stock.component.html"() {
    sold_stock_component_default = `			<!-- Start Content -->
...
// angular:jit:style:src/app/features/reports/item-report/sold-stock/sold-stock.component.scss
var sold_stock_component_default2;
var init_sold_stock_component2 = __esm({
  "angular:jit:style:src/app/features/reports/item-report/sold-stock/sold-stock.component.scss"() {
    sold_stock_component_default2 = "/* src/app/features/reports/item-report/sold-stock/sold-stock.component.scss */\n/*# sourceMappingURL=sold-stock.component.css.map */\n";
  }
});

// src/app/features/reports/item-report/sold-stock/sold-stock.component.ts
var SoldStockComponent;
var init_sold_stock_component3 = __esm({
  "src/app/features/reports/item-report/sold-stock/sold-stock.component.ts"() {
    "use strict";
    init_tslib_es6();
    init_sold_stock_component();
    init_sold_stock_component2();
    init_core();
    init_sort();
    init_table();
    init_router();
    ...
    init_custom_pagination_component();
    init_date_range_picker_2_component();
    SoldStockComponent = class SoldStockComponent2 {
      data;
      router;
      pagination;
      routes = routes;
    ...
    SoldStockComponent = __decorate([
      Component({
        ...
        template: sold_stock_component_default,
        styles: [sold_stock_component_default2]
      })
    ], SoldStockComponent);
  }
});

// src/app/features/reports/item-report/sold-stock/sold-stock.component.spec.ts
var require_sold_stock_component_spec = __commonJS({
  "src/app/features/reports/item-report/sold-stock/sold-stock.component.spec.ts"(exports) {
    init_testing();
    init_sold_stock_component3();
...
export default require_sold_stock_component_spec();
//# sourceMappingURL=spec-app-features-reports-item-report-sold-stock-sold-stock.component.spec.js.map
