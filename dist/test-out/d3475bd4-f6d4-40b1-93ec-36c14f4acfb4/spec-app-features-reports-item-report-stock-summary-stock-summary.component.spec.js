...
var init_stock_summary_component3 = __esm({
  "src/app/features/reports/item-report/stock-summary/stock-summary.component.ts"() {
    ...
    init_custom_pagination_component();
    init_date_range_picker_2_component();
    StockSummaryComponent = class StockSummaryComponent2 {
      data;
      router;
      pagination;
      routes = routes;
    ...
    StockSummaryComponent = __decorate([
      Component({
        ...
        template: stock_summary_component_default,
        styles: [stock_summary_component_default2]
      })
    ], StockSummaryComponent);
  }
});

// src/app/features/reports/item-report/stock-summary/stock-summary.component.spec.ts
var require_stock_summary_component_spec = __commonJS({
  "src/app/features/reports/item-report/stock-summary/stock-summary.component.spec.ts"(exports) {
    init_testing();
    init_stock_summary_component3();
...
export default require_stock_summary_component_spec();
//# sourceMappingURL=spec-app-features-reports-item-report-stock-summary-stock-summary.component.spec.js.map
