...
// angular:jit:template:src/app/features/reports/transaction-report/quotation-report/quotation-report.component.html
var quotation_report_component_default;
var init_quotation_report_component = __esm({
  "angular:jit:template:src/app/features/reports/transaction-report/quotation-report/quotation-report.component.html"() {
    quotation_report_component_default = `			<!-- Start Content -->
...
// angular:jit:style:src/app/features/reports/transaction-report/quotation-report/quotation-report.component.scss
var quotation_report_component_default2;
var init_quotation_report_component2 = __esm({
  "angular:jit:style:src/app/features/reports/transaction-report/quotation-report/quotation-report.component.scss"() {
    quotation_report_component_default2 = "/* src/app/features/reports/transaction-report/quotation-report/quotation-report.component.scss */\n/*# sourceMappingURL=quotation-report.component.css.map */\n";
  }
});

// src/app/features/reports/transaction-report/quotation-report/quotation-report.component.ts
var QuotationReportComponent;
var init_quotation_report_component3 = __esm({
  "src/app/features/reports/transaction-report/quotation-report/quotation-report.component.ts"() {
    "use strict";
    init_tslib_es6();
    init_quotation_report_component();
    init_quotation_report_component2();
    init_core();
    init_sort();
    init_table();
    init_router();
    ...
    init_date_range_picker_component();
    init_date_range_picker_2_component();
    QuotationReportComponent = class QuotationReportComponent2 {
      data;
      router;
      pagination;
      routes = routes;
    ...
    QuotationReportComponent = __decorate([
      Component({
        ...
        template: quotation_report_component_default,
        styles: [quotation_report_component_default2]
      })
    ], QuotationReportComponent);
  }
});

// src/app/features/reports/transaction-report/quotation-report/quotation-report.component.spec.ts
var require_quotation_report_component_spec = __commonJS({
  "src/app/features/reports/transaction-report/quotation-report/quotation-report.component.spec.ts"(exports) {
    init_testing();
    init_quotation_report_component3();
...
export default require_quotation_report_component_spec();
//# sourceMappingURL=spec-app-features-reports-transaction-report-quotation-report-quotation-report.component.spec.js.map
