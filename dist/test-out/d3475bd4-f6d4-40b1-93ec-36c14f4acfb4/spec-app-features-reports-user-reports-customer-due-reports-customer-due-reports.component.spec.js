...
// angular:jit:template:src/app/features/reports/user-reports/customer-due-reports/customer-due-reports.component.html
var customer_due_reports_component_default;
var init_customer_due_reports_component = __esm({
  "angular:jit:template:src/app/features/reports/user-reports/customer-due-reports/customer-due-reports.component.html"() {
    customer_due_reports_component_default = `    <!-- Start Content -->
...
// angular:jit:style:src/app/features/reports/user-reports/customer-due-reports/customer-due-reports.component.scss
var customer_due_reports_component_default2;
var init_customer_due_reports_component2 = __esm({
  "angular:jit:style:src/app/features/reports/user-reports/customer-due-reports/customer-due-reports.component.scss"() {
    customer_due_reports_component_default2 = "/* src/app/features/reports/user-reports/customer-due-reports/customer-due-reports.component.scss */\n/*# sourceMappingURL=customer-due-reports.component.css.map */\n";
  }
});

// src/app/features/reports/user-reports/customer-due-reports/customer-due-reports.component.ts
var CustomerDueReportsComponent;
var init_customer_due_reports_component3 = __esm({
  "src/app/features/reports/user-reports/customer-due-reports/customer-due-reports.component.ts"() {
    "use strict";
    init_tslib_es6();
    init_customer_due_reports_component();
    init_customer_due_reports_component2();
    init_core();
    init_sort();
    init_table();
    init_router();
    ...
    init_slider();
    init_date_range_picker_2_component();
    CustomerDueReportsComponent = class CustomerDueReportsComponent2 {
      data;
      router;
      pagination;
      routes = routes;
    ...
    CustomerDueReportsComponent = __decorate([
      Component({
        selector: "app-customer-due-reports",
        imports: [
          CommonModule,
          FormsModule,
          CustomPaginationComponent,
        ...
        template: customer_due_reports_component_default,
        styles: [customer_due_reports_component_default2]
      })
    ], CustomerDueReportsComponent);
  }
});

// src/app/features/reports/user-reports/customer-due-reports/customer-due-reports.component.spec.ts
var require_customer_due_reports_component_spec = __commonJS({
  "src/app/features/reports/user-reports/customer-due-reports/customer-due-reports.component.spec.ts"(exports) {
    init_testing();
    init_customer_due_reports_component3();
...
export default require_customer_due_reports_component_spec();
//# sourceMappingURL=spec-app-features-reports-user-reports-customer-due-reports-customer-due-reports.component.spec.js.map
