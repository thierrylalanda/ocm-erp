...
// angular:jit:template:src/app/features/super-admin/plans-list/plans-list.component.html
var plans_list_component_default;
var init_plans_list_component = __esm({
  "angular:jit:template:src/app/features/super-admin/plans-list/plans-list.component.html"() {
    plans_list_component_default = `<div class="subscription-plane-head">
  <ul>
    <li>
...
// angular:jit:style:src/app/features/super-admin/plans-list/plans-list.component.scss
var plans_list_component_default2;
var init_plans_list_component2 = __esm({
  "angular:jit:style:src/app/features/super-admin/plans-list/plans-list.component.scss"() {
    plans_list_component_default2 = "/* src/app/features/super-admin/plans-list/plans-list.component.scss */\n/*# sourceMappingURL=plans-list.component.css.map */\n";
  }
});

// src/app/features/super-admin/plans-list/plans-list.component.ts
var PlansListComponent;
var init_plans_list_component3 = __esm({
  "src/app/features/super-admin/plans-list/plans-list.component.ts"() {
    "use strict";
    init_tslib_es6();
    init_plans_list_component();
    init_plans_list_component2();
    init_common();
    init_core();
    init_sort();
    init_table();
    ...
    init_ngx_bootstrap_datepicker();
    init_custom_pagination_component();
    PlansListComponent = class PlansListComponent2 {
      data;
      pagination;
      router;
      routes = routes;
    ...
    PlansListComponent = __decorate([
      Component({
        ...
        template: plans_list_component_default,
        imports: [CommonModule, MatSelectModule, BsDatepickerModule, CustomPaginationComponent, MatSortModule, RouterLink],
        styles: [plans_list_component_default2]
      })
    ], PlansListComponent);
  }
});

// src/app/features/super-admin/plans-list/plans-list.component.spec.ts
var require_plans_list_component_spec = __commonJS({
  "src/app/features/super-admin/plans-list/plans-list.component.spec.ts"(exports) {
    init_testing();
    init_plans_list_component3();
...
export default require_plans_list_component_spec();
//# sourceMappingURL=spec-app-features-super-admin-plans-list-plans-list.component.spec.js.map
