...
// angular:jit:template:src/app/features/ui-interface/base-ui/list-group/list-group.component.html
var list_group_component_default;
var init_list_group_component = __esm({
  "angular:jit:template:src/app/features/ui-interface/base-ui/list-group/list-group.component.html"() {
    list_group_component_default = `			<!-- Start Content -->
            <div class="">
...
// angular:jit:style:src/app/features/ui-interface/base-ui/list-group/list-group.component.scss
var list_group_component_default2;
var init_list_group_component2 = __esm({
  "angular:jit:style:src/app/features/ui-interface/base-ui/list-group/list-group.component.scss"() {
    list_group_component_default2 = "/* src/app/features/ui-interface/base-ui/list-group/list-group.component.scss */\n/*# sourceMappingURL=list-group.component.css.map */\n";
  }
});

// src/app/features/ui-interface/base-ui/list-group/list-group.component.ts
var ListGroupComponent;
var init_list_group_component3 = __esm({
  "src/app/features/ui-interface/base-ui/list-group/list-group.component.ts"() {
    "use strict";
    init_tslib_es6();
    init_list_group_component();
    init_list_group_component2();
    init_core();
    init_common();
    ListGroupComponent = class ListGroupComponent2 {
    };
    ListGroupComponent = __decorate([
      Component({
        selector: "app-list-group",
        template: list_group_component_default,
        imports: [CommonModule],
        styles: [list_group_component_default2]
      })
    ], ListGroupComponent);
  }
});

// src/app/features/ui-interface/base-ui/list-group/list-group.component.spec.ts
var require_list_group_component_spec = __commonJS({
  "src/app/features/ui-interface/base-ui/list-group/list-group.component.spec.ts"(exports) {
    init_testing();
    init_list_group_component3();
...
export default require_list_group_component_spec();
//# sourceMappingURL=spec-app-features-ui-interface-base-ui-list-group-list-group.component.spec.js.map
