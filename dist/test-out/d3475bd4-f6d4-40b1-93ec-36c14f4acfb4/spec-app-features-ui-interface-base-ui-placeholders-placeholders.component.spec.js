...
// angular:jit:template:src/app/features/ui-interface/base-ui/placeholders/placeholders.component.html
var placeholders_component_default;
var init_placeholders_component = __esm({
  "angular:jit:template:src/app/features/ui-interface/base-ui/placeholders/placeholders.component.html"() {
    placeholders_component_default = `            <!-- Start Content -->
            <div class="">
...
// angular:jit:style:src/app/features/ui-interface/base-ui/placeholders/placeholders.component.scss
var placeholders_component_default2;
var init_placeholders_component2 = __esm({
  "angular:jit:style:src/app/features/ui-interface/base-ui/placeholders/placeholders.component.scss"() {
    placeholders_component_default2 = "/* src/app/features/ui-interface/base-ui/placeholders/placeholders.component.scss */\n/*# sourceMappingURL=placeholders.component.css.map */\n";
  }
});

// src/app/features/ui-interface/base-ui/placeholders/placeholders.component.ts
var PlaceholdersComponent;
var init_placeholders_component3 = __esm({
  "src/app/features/ui-interface/base-ui/placeholders/placeholders.component.ts"() {
    "use strict";
    init_tslib_es6();
    init_placeholders_component();
    init_placeholders_component2();
    init_core();
    init_common();
    PlaceholdersComponent = class PlaceholdersComponent2 {
    };
    PlaceholdersComponent = __decorate([
      Component({
        selector: "app-placeholders",
        template: placeholders_component_default,
        imports: [CommonModule],
        styles: [placeholders_component_default2]
      })
    ], PlaceholdersComponent);
  }
});

// src/app/features/ui-interface/base-ui/placeholders/placeholders.component.spec.ts
var require_placeholders_component_spec = __commonJS({
  "src/app/features/ui-interface/base-ui/placeholders/placeholders.component.spec.ts"(exports) {
    init_testing();
    init_placeholders_component3();
...
export default require_placeholders_component_spec();
//# sourceMappingURL=spec-app-features-ui-interface-base-ui-placeholders-placeholders.component.spec.js.map
