...
// src/app/features/ui-interface/forms/form-mask/form-mask.component.spec.ts
init_testing();

// src/app/features/ui-interface/forms/form-mask/form-mask.component.ts
init_tslib_es6();

// angular:jit:template:src/app/features/ui-interface/forms/form-mask/form-mask.component.html
var form_mask_component_default = `              <!-- Page Header -->
...
// angular:jit:style:src/app/features/ui-interface/forms/form-mask/form-mask.component.scss
var form_mask_component_default2 = "/* src/app/features/ui-interface/forms/form-mask/form-mask.component.scss */\n/*# sourceMappingURL=form-mask.component.css.map */\n";
...
NgxMaskApplierService.\u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "14.2.8", ngImport: core_exports, type: NgxMaskApplierService, deps: [], target: FactoryTarget.Injectable });
NgxMaskApplierService.\u0275prov = \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "14.2.8", ngImport: core_exports, type: NgxMaskApplierService });
\u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.8", ngImport: core_exports, type: NgxMaskApplierService, decorators: [{
  type: Injectable
}] });
...
NgxMaskService.\u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "14.2.8", ngImport: core_exports, type: NgxMaskService, deps: null, target: FactoryTarget.Injectable });
NgxMaskService.\u0275prov = \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "14.2.8", ngImport: core_exports, type: NgxMaskService });
\u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.8", ngImport: core_exports, type: NgxMaskService, decorators: [{
  type: Injectable
}] });
...
NgxMaskDirective.\u0275dir = \u0275\u0275ngDeclareDirective({ minVersion: "14.0.0", version: "14.2.8", type: NgxMaskDirective, selector: "input[mask], textarea[mask]", inputs: { maskExpression: ["mask", "maskExpression"], specialCharacters: "specialCharacters", patterns: "patterns", prefix: "prefix", suffix: "suffix", thousandSeparator: "thousandSeparator", decimalMarker: "decimalMarker", dropSpecialCharacters: "dropSpecialCharacters", hiddenInput: "hiddenInput", showMaskTyped: "showMaskTyped", placeHolderCharacter: "placeHolderCharacter", shownMaskExpression: "shownMaskExpression", showTemplate: "showTemplate", clearIfNotMatch: "clearIfNotMatch", validation: "validation", separatorLimit: "separatorLimit", allowNegativeNumbers: "allowNegativeNumbers", leadZeroDateTime: "leadZeroDateTime", leadZero: "leadZero", triggerOnMaskChange: "triggerOnMaskChange", apm: "apm", inputTransformFn: "inputTransformFn", outputTransformFn: "outputTransformFn", keepCharacterPositions: "keepCharacterPositions" }, outputs: { maskFilled: "maskFilled" }, host: { listeners: { "paste": "onPaste()", "focus": "onFocus($event)", "ngModelChange": "onModelChange($event)", "input": "onInput($event)", "compositionstart": "onCompositionStart($event)", "compositionend": "onCompositionEnd($event)", "blur": "onBlur($event)", "click": "onClick($event)", "keydown": "onKeyDown($event)" } }, providers: [
  ...
  NgxMaskService
], exportAs: ["mask", "ngxMask"], usesOnChanges: true, ngImport: core_exports });
\u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.8", ngImport: core_exports, type: NgxMaskDirective, decorators: [{
  type: Directive,
  args: [{
...
var NgxMaskPipe = class {
  ...
  transform(value, mask, _a = {}) {
    var _b = _a, { patterns } = _b, config = __objRest(_b, ["patterns"]);
...
NgxMaskPipe.\u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "14.2.8", ngImport: core_exports, type: NgxMaskPipe, deps: [{ token: NgxMaskService }], target: FactoryTarget.Pipe });
NgxMaskPipe.\u0275pipe = \u0275\u0275ngDeclarePipe({ minVersion: "14.0.0", version: "14.2.8", ngImport: core_exports, type: NgxMaskPipe, name: "mask" });
\u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.8", ngImport: core_exports, type: NgxMaskPipe, decorators: [{
  type: Pipe,
  args: [{
    name: "mask",
    pure: true
...
NgxMaskModule.\u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "14.2.8", ngImport: core_exports, type: NgxMaskModule, deps: [], target: FactoryTarget.NgModule });
NgxMaskModule.\u0275mod = \u0275\u0275ngDeclareNgModule({ minVersion: "14.0.0", version: "14.2.8", ngImport: core_exports, type: NgxMaskModule, declarations: [NgxMaskDirective, NgxMaskPipe], exports: [NgxMaskDirective, NgxMaskPipe] });
NgxMaskModule.\u0275inj = \u0275\u0275ngDeclareInjector({ minVersion: "12.0.0", version: "14.2.8", ngImport: core_exports, type: NgxMaskModule });
\u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.8", ngImport: core_exports, type: NgxMaskModule, decorators: [{
  type: NgModule,
  args: [{
...
// src/app/features/ui-interface/forms/form-mask/form-mask.component.ts
var FormMaskComponent = class FormMaskComponent2 {
  formBuilder;
  basicForm;
  customPatterns = {
...
FormMaskComponent = __decorate([
  Component({
    ...
    template: form_mask_component_default,
    imports: [CommonModule, NgxMaskModule, FormsModule, ReactiveFormsModule],
    styles: [form_mask_component_default2]
  })
], FormMaskComponent);
...
//# sourceMappingURL=spec-app-features-ui-interface-forms-form-mask-form-mask.component.spec.js.map
