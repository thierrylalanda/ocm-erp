...
// angular:jit:template:src/app/modules/setting/presentation/pages/website-settings/plugin-manager/plugin-manager.component.html
...
// angular:jit:style:src/app/modules/setting/presentation/pages/website-settings/plugin-manager/plugin-manager.component.scss
var plugin_manager_component_default2;
var init_plugin_manager_component2 = __esm({
  "angular:jit:style:src/app/modules/setting/presentation/pages/website-settings/plugin-manager/plugin-manager.component.scss"() {
    plugin_manager_component_default2 = "/* src/app/modules/setting/presentation/pages/website-settings/plugin-manager/plugin-manager.component.scss */\n/*# sourceMappingURL=plugin-manager.component.css.map */\n";
  }
});
...
// src/app/modules/setting/presentation/pages/website-settings/plugin-manager/plugin-manager.component.spec.ts
var require_plugin_manager_component_spec = __commonJS({
  "src/app/modules/setting/presentation/pages/website-settings/plugin-manager/plugin-manager.component.spec.ts"(exports) {
    init_testing();
...
//# sourceMappingURL=spec-app-modules-setting-presentation-pages-website-settings-plugin-manager-plugin-manager.component.spec.js.map
