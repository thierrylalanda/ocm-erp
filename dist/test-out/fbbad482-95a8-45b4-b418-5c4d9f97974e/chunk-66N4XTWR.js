...
// angular:jit:template:src/app/features/common/side-menus/side-menu-two/side-menu-two.component.html
var side_menu_two_component_default;
var init_side_menu_two_component = __esm({
  "angular:jit:template:src/app/features/common/side-menus/side-menu-two/side-menu-two.component.html"() {
    side_menu_two_component_default = `<!-- Sidebar -->
<div
...
// angular:jit:style:src/app/features/common/side-menus/side-menu-two/side-menu-two.component.scss
var side_menu_two_component_default2;
var init_side_menu_two_component2 = __esm({
  "angular:jit:style:src/app/features/common/side-menus/side-menu-two/side-menu-two.component.scss"() {
    side_menu_two_component_default2 = "/* src/app/features/common/side-menus/side-menu-two/side-menu-two.component.scss */\n::ng-deep .custom-scrollbars {\n  background-color: rgb(117, 57, 255) !important;\n}\n::ng-deep .custom-scrollbars:hover,\n::ng-deep .custom-scrollbars:active {\n  background-color: rgb(117, 57, 255) !important;\n}\n/*# sourceMappingURL=side-menu-two.component.css.map */\n";
  }
});

// src/app/features/common/side-menus/side-menu-two/side-menu-two.component.ts
var SideMenuTwoComponent;
var init_side_menu_two_component3 = __esm({
  "src/app/features/common/side-menus/side-menu-two/side-menu-two.component.ts"() {
    "use strict";
    init_tslib_es6();
    init_side_menu_two_component();
    init_side_menu_two_component2();
    init_core();
    init_router();
    init_core_index();
    init_side_bar_service();
    init_common();
    init_ngx_scrollbar();
    SideMenuTwoComponent = class SideMenuTwoComponent2 {
      router;
      data;
      sideBar;
      auth;
    ...
    SideMenuTwoComponent = __decorate([
      Component({
        selector: "app-side-menu-two",
        template: side_menu_two_component_default,
        imports: [CommonModule, RouterLink, NgScrollbarModule, RouterLinkActive],
        styles: [side_menu_two_component_default2]
      })
...
export {
  SideMenuTwoComponent,
  init_side_menu_two_component3 as init_side_menu_two_component
};
//# sourceMappingURL=chunk-66N4XTWR.js.map
