...
var isNil, camelToDashed, cleanObject, toStyleString, NgxEditorError, uniq, clamp;
var init_ngx_editor_utils = __esm({
  "node_modules/ngx-editor/fesm2022/ngx-editor-utils.mjs"() {
    "use strict";
    isNil = (val) => {
    ...
    NgxEditorError = class extends Error {
      constructor(message) {
        super(message);
...
var Fragment, found, Mark, ReplaceError, Slice, ResolvedPos, ResolveCache, resolveCacheSize, resolveCache, NodeRange, emptyAttrs, Node2, TextNode, ContentMatch, TokenStream, NodeType, Attribute, MarkType, Schema, DOMParser, blockTags, ignoreTags, listTags, OPT_PRESERVE_WS, OPT_PRESERVE_WS_FULL, OPT_OPEN_LEFT, NodeContext, ParseContext, DOMSerializer, suspiciousAttributeCache;
...
var link, em, strong, code, u, s, textColor, textBackgroundColor, sup, sub, marks, doc3, text, paragraph, blockquote, horizontalRule, heading, codeBlock, hardBreak, image, listItem2, orderedList2, bulletList2, nodes, schema;
var init_ngx_editor_schema = __esm({
  "node_modules/ngx-editor/fesm2022/ngx-editor-schema.mjs"() {
    "use strict";
    init_dist6();
    init_ngx_editor_utils();
    init_dist2();
    link = {
      attrs: {
        href: {},
    ...
    listItem2 = __spreadProps(__spreadValues({}, listItem), {
      content: "paragraph block*"
    });
    orderedList2 = __spreadProps(__spreadValues({}, orderedList), {
      content: "list_item+",
      group: "block"
    });
    bulletList2 = __spreadProps(__spreadValues({}, bulletList), {
      content: "list_item+",
      group: "block"
    });
    nodes = {
...
var deleteSelection, joinBackward, selectNodeBackward, joinForward, selectNodeForward, lift2, newlineInCode, exitCode, createParagraphNear, liftEmptyBlock, splitBlock, selectAll, selectTextblockStart, selectTextblockEnd, backspace, del, pcBaseKeymap, macBaseKeymap, mac2, baseKeymap;
...
var isMarkActive, findNodeType, isNodeActive, getSelectionMarks, getSelectionNodes, markApplies2, markInputRule, canInsert;
var init_ngx_editor_helpers = __esm({
  "node_modules/ngx-editor/fesm2022/ngx-editor-helpers.mjs"() {
    "use strict";
    init_dist8();
    isMarkActive = (state, type) => {
    ...
    markInputRule = (regexp, markType, attrs) => {
      return new InputRule(regexp, (state, match, start, end) => {
        const { tr } = state;
        const from2 = start;
        let to = end;
...
var removeLink, applyMark, removeMark2;
var init_ngx_editor_commands = __esm({
  "node_modules/ngx-editor/fesm2022/ngx-editor-commands.mjs"() {
    "use strict";
    init_dist4();
    init_ngx_editor_helpers();
    removeLink = () => {
      return (state, dispatch) => {
...
var sides, alignments, placements, min, max, round, createCoords, oppositeSideMap, oppositeAlignmentMap, yAxisSides;
...
var computePosition, autoPlacement, originSides, offset;
...
var noOffsets, absoluteOrFixed, getElementRects, platform, detectOverflow2, offset2, autoPlacement2, computePosition2;
...
var base, shift2, mac3, ie2, i, i, i, code3;
...
var editablePlugin, PLACEHOLDER_CLASSNAME, placeholderPlugin, attributesPlugin, focusPlugin, blurPlugin, ImageViewComponent, ImageRezieView, imageResizePlugin, HTTP_LINK_REGEX, linkify, linkifyPlugin, isString, getTrustedTypes, isTrustedHtml, isHtml, emptyDoc, toHTML, toDoc, parseContent, NgxEditorComponent, MenuService, Mark2, Blockqote, HorizontalRule, ListItem, Heading, TextAlign, defaultOptions, Link$1, Image$1, TextColor$1, SAFE_MARKS, FormatClear, indentNodeTypes, minIndent, maxIndent, udpateIndentLevel, Indent, History, STRONG, EM, CODE, UNDERLINE, STRIKE, BLOCKQUOTE, HORIZONTAL_RULE, FORMAT_CLEAR, UL, OL, H1, H2, H3, H4, H5, H6, ALIGN_LEFT, ALIGN_CENTER, ALIGN_RIGHT, ALIGN_JUSTIFY, LINK, IMAGE, TEXT_COLOR, TEXT_BACKGROUND_COLOR, INDENT, OUTDENT, SUPERSCRIPT, SUBSCRIPT, UNDO, REDO, ToggleCommands, InsertCommands, Link2, Image2, TextColor2, TextBackgroundColor, defaults, Locals, bold, italic, code2, underline, strike, orderedList3, bulletList3, quote, link2, unlink, image2, alignLeft, alignCenter, alignRight, alignJustify, textColor2, colorFill, horizontalRule2, formatClear, indent, outdent, superscript, subscript, undo2, redo2, DEFAULT_ICON_HEIGHT, DEFAULT_ICON_WIDTH, DEFAULT_ICON_FILL, icons, Icon, NgxEditorServiceConfig, NgxEditorService, provideMyServiceOptions, SanitizeHtmlPipe, ToggleCommandComponent, InsertCommandComponent, DEFAULT_LINK_OPTIONS, LinkComponent, DropdownComponent, ImageComponent, ColorPickerComponent, TOOLBAR_MINIMAL, DEFAULT_COLOR_PRESETS, MenuComponent, BubbleComponent, FloatingMenuComponent, MenuModule, NGX_EDITOR_CONFIG_TOKEN, defaultConfig, NgxEditorModule, isEmptyInputValue, hasValidLength, isDocEmpty, Validators2, execMark, EditorCommands, isMacOs, blockQuoteRule, orderedListRule, bulletListRule, codeBlockRule, headingRule, boldRule, emRule, buildInputRules, getKeyboardShortcuts, getDefaultPlugins, defaultFeatures, DEFAULT_OPTIONS, Editor;
var init_ngx_editor = __esm({
  "node_modules/ngx-editor/fesm2022/ngx-editor.mjs"() {
    "use strict";
    init_core();
    init_core();
    ...
    init_common();
    init_dist2();
    init_ngx_editor_schema();
    init_dist7();
    init_ngx_editor_commands();
    init_ngx_editor_helpers();
    init_dist6();
    init_dist10();
    init_platform_browser();
    ...
    PLACEHOLDER_CLASSNAME = "NgxEditor__Placeholder";
    placeholderPlugin = (text2) => {
      return new Plugin({
        ...
        props: {
          decorations(state) {
            const { doc: doc4 } = state;
            const { textContent, childCount } = doc4;
    ...
    ImageViewComponent = class _ImageViewComponent {
      src;
      alt = "";
      title = "";
      outerWidth = "";
      ...
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "18.2.2", ngImport: core_exports, type: _ImageViewComponent, deps: [], target: FactoryTarget.Component });
      static \u0275cmp = \u0275\u0275ngDeclareComponent({ minVersion: "14.0.0", version: "18.2.2", type: _ImageViewComponent, selector: "ngx-image-view", inputs: { src: "src", alt: "alt", title: "title", outerWidth: "outerWidth", selected: "selected", view: "view" }, outputs: { imageResize: "imageResize" }, viewQueries: [{ propertyName: "imgEl", first: true, predicate: ["imgEl"], descendants: true, static: true }], ngImport: core_exports, template: `<span class="NgxEditor__ImageWrapper" [ngClass]="{ 'NgxEditor__Resizer--Active': selected }" [style.width]="outerWidth">
...
`, styles: ["*,*:before,*:after{box-sizing:border-box}img{width:100%;height:100%}.NgxEditor__ImageWrapper{position:relative;display:inline-block;line-height:0;padding:2px}.NgxEditor__ImageWrapper.NgxEditor__Resizer--Active{padding:1px;border:1px solid #1a73e8}.NgxEditor__ImageWrapper .NgxEditor__ResizeHandle{position:absolute;height:100%;width:100%}.NgxEditor__ImageWrapper .NgxEditor__ResizeHandle .NgxEditor__ResizeHandle--TL,.NgxEditor__ImageWrapper .NgxEditor__ResizeHandle .NgxEditor__ResizeHandle--BL,.NgxEditor__ImageWrapper .NgxEditor__ResizeHandle .NgxEditor__ResizeHandle--TR,.NgxEditor__ImageWrapper .NgxEditor__ResizeHandle .NgxEditor__ResizeHandle--BR{position:absolute;width:7px;height:7px;background-color:#1a73e8;border:1px solid white}.NgxEditor__ImageWrapper .NgxEditor__ResizeHandle .NgxEditor__ResizeHandle--BR{bottom:-5px;right:-5px;cursor:se-resize}.NgxEditor__ImageWrapper .NgxEditor__ResizeHandle .NgxEditor__ResizeHandle--TR{top:-5px;right:-5px;cursor:ne-resize}.NgxEditor__ImageWrapper .NgxEditor__ResizeHandle .NgxEditor__ResizeHandle--TL{top:-5px;left:-5px;cursor:nw-resize}.NgxEditor__ImageWrapper .NgxEditor__ResizeHandle .NgxEditor__ResizeHandle--BL{bottom:-5px;left:-5px;cursor:sw-resize}\n"], dependencies: [{ kind: "directive", type: NgClass, selector: "[ngClass]", inputs: ["class", "ngClass"] }, { kind: "directive", type: NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }] });
    ...
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "18.2.2", ngImport: core_exports, type: ImageViewComponent, decorators: [{
      type: Component,
...
`, styles: ["*,*:before,*:after{box-sizing:border-box}img{width:100%;height:100%}.NgxEditor__ImageWrapper{position:relative;display:inline-block;line-height:0;padding:2px}.NgxEditor__ImageWrapper.NgxEditor__Resizer--Active{padding:1px;border:1px solid #1a73e8}.NgxEditor__ImageWrapper .NgxEditor__ResizeHandle{position:absolute;height:100%;width:100%}.NgxEditor__ImageWrapper .NgxEditor__ResizeHandle .NgxEditor__ResizeHandle--TL,.NgxEditor__ImageWrapper .NgxEditor__ResizeHandle .NgxEditor__ResizeHandle--BL,.NgxEditor__ImageWrapper .NgxEditor__ResizeHandle .NgxEditor__ResizeHandle--TR,.NgxEditor__ImageWrapper .NgxEditor__ResizeHandle .NgxEditor__ResizeHandle--BR{position:absolute;width:7px;height:7px;background-color:#1a73e8;border:1px solid white}.NgxEditor__ImageWrapper .NgxEditor__ResizeHandle .NgxEditor__ResizeHandle--BR{bottom:-5px;right:-5px;cursor:se-resize}.NgxEditor__ImageWrapper .NgxEditor__ResizeHandle .NgxEditor__ResizeHandle--TR{top:-5px;right:-5px;cursor:ne-resize}.NgxEditor__ImageWrapper .NgxEditor__ResizeHandle .NgxEditor__ResizeHandle--TL{top:-5px;left:-5px;cursor:nw-resize}.NgxEditor__ImageWrapper .NgxEditor__ResizeHandle .NgxEditor__ResizeHandle--BL{bottom:-5px;left:-5px;cursor:sw-resize}\n"] }]
      ...
      fragment.forEach((child) => {
        if (child.isText) {
          ...
          if (match) {
            ...
            const { link: link3 } = child.type.schema.marks;
            if (start > 0) {
              linkified.push(child.cut(pos, start));
            }
            const urlText = text2.slice(start, end);
            linkified.push(child.cut(start, end).mark(link3.create({ href: urlText }).addToSet(child.marks)));
            pos = end;
          }
          if (pos < text2.length) {
    ...
    NgxEditorComponent = class _NgxEditorComponent {
      renderer;
      injector;
      elementRef;
    ...
    }], ctorParameters: () => [{ type: Renderer2 }, { type: Injector }, { type: ElementRef }], propDecorators: { ngxEditor: [{
      type: ViewChild,
    ...
    MenuService = class _MenuService {
      editor;
      customMenuRefChange = new Subject();
      setCustomMenuRef(c) {
        this.customMenuRefChange.next(c);
      }
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "18.2.2", ngImport: core_exports, type: _MenuService, deps: [], target: FactoryTarget.Injectable });
      static \u0275prov = \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "18.2.2", ngImport: core_exports, type: _MenuService, providedIn: "root" });
    };
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "18.2.2", ngImport: core_exports, type: MenuService, decorators: [{
      type: Injectable,
      args: [{
        providedIn: "root"
      }]
    ...
    Heading = class {
      ...
      toggle() {
        return (state, dispatch) => {
          const { schema: schema2, selection, doc: doc4 } = state;
          const type = schema2.nodes["heading"];
          if (!type) {
            return false;
          }
          ...
          return setBlockType2(type, __spreadProps(__spreadValues({}, attrs), { level: this.level }))(state, dispatch);
        };
      }
      isActive(state) {
        const { schema: schema2 } = state;
        ...
        return (state, dispatch) => {
          ...
          doc4.nodesBetween(from2, to, (node, pos) => {
            ...
            if ([schema2.nodes["paragraph"], schema2.nodes["heading"]].includes(nodeType)) {
              ...
              tr.setNodeMarkup(pos, nodeType, __spreadProps(__spreadValues({}, node.attrs), { align }));
            }
            return true;
          });
          if (!applicable) {
    ...
    Image$1 = class Image {
      insert(src, attrs) {
        return (state, dispatch) => {
          const { schema: schema2, tr, selection } = state;
    ...
    FormatClear = class {
      insert() {
        return (state, dispatch) => {
          const { tr } = state;
          const { ranges, empty: empty2 } = tr.selection;
          if (empty2) {
            return true;
          }
    ...
    indentNodeTypes = ["paragraph", "heading", "blockquote"];
    minIndent = 0;
    maxIndent = 10;
    udpateIndentLevel = (tr, pos, method) => {
    ...
    STRONG = new Mark2("strong");
    EM = new Mark2("em");
    CODE = new Mark2("code");
    UNDERLINE = new Mark2("u");
    STRIKE = new Mark2("s");
    BLOCKQUOTE = new Blockqote();
    HORIZONTAL_RULE = new HorizontalRule();
    FORMAT_CLEAR = new FormatClear();
    UL = new ListItem(true);
    OL = new ListItem(false);
    H1 = new Heading(1);
    H2 = new Heading(2);
    H3 = new Heading(3);
    H4 = new Heading(4);
    H5 = new Heading(5);
    H6 = new Heading(6);
    ALIGN_LEFT = new TextAlign("left");
    ALIGN_CENTER = new TextAlign("center");
    ALIGN_RIGHT = new TextAlign("right");
    ALIGN_JUSTIFY = new TextAlign("justify");
    LINK = new Link$1();
    IMAGE = new Image$1();
    TEXT_COLOR = new TextColor$1("text_color", "color");
    TEXT_BACKGROUND_COLOR = new TextColor$1("text_background_color", "backgroundColor");
    INDENT = new Indent("increase");
    OUTDENT = new Indent("decrease");
    SUPERSCRIPT = new Mark2("sup");
    SUBSCRIPT = new Mark2("sub");
    UNDO = new History("undo");
    REDO = new History("redo");
    ToggleCommands = {
      bold: STRONG,
      italic: EM,
      code: CODE,
...
`;
    indent = '<path d="M0 0h24v24H0V0z" fill="none"/><path d="M3 21h18v-2H3v2zM3 8v8l4-4-4-4zm8 9h10v-2H11v2zM3 3v2h18V3H3zm8 6h10V7H11v2zm0 4h10v-2H11v2z"/>';
    outdent = '<path d="M0 0h24v24H0V0z" fill="none"/><path d="M11 17h10v-2H11v2zm-8-5l4 4V8l-4 4zm0 9h18v-2H3v2zM3 3v2h18V3H3zm8 6h10V7H11v2zm0 4h10v-2H11v2z"/>';
    superscript = '<g><rect fill="none" height="20" width="20"/><path d="M17,6l-1,0v1h2v1l-3,0V6c0-0.55,0.45-1,1-1l1,0l0-1h-2V3l2,0c0.55,0,1,0.45,1,1v1C18,5.55,17.55,6,17,6z M5.63,16h1.9 l2.43-3.87h0.08L12.47,16h1.9l-3.32-5.2l3.1-4.8h-1.91l-2.19,3.56H9.96L7.75,6h-1.9l3.09,4.8L5.63,16z"/></g>';
    subscript = '<g><rect fill="none" height="20" width="20"/><path d="M17,15l-1,0v1h2v1h-3v-2c0-0.55,0.45-1,1-1l1,0l0-1h-2v-1l2,0c0.55,0,1,0.45,1,1v1C18,14.55,17.55,15,17,15z M5.63,14h1.9 l2.43-3.87h0.08L12.47,14h1.9l-3.32-5.2l3.1-4.8h-1.91l-2.19,3.56H9.96L7.75,4h-1.9l3.09,4.8L5.63,14z"/></g>';
    undo2 = '<path d="M0 0h24v24H0V0z" fill="none"/><path d="M12.5 8c-2.65 0-5.05.99-6.9 2.6L2 7v9h9l-3.62-3.62c1.39-1.16 3.16-1.88 5.12-1.88 3.54 0 6.55 2.31 7.6 5.5l2.37-.78C21.08 11.03 17.15 8 12.5 8z"/>';
    redo2 = '<path d="M0 0h24v24H0V0z" fill="none"/><path d="M18.4 10.6C16.55 8.99 14.15 8 11.5 8c-4.65 0-8.58 3.03-9.96 7.22L3.9 16c1.05-3.19 4.05-5.5 7.6-5.5 1.95 0 3.73.72 5.12 1.88L13 16h9V7l-3.6 3.6z"/>';
    DEFAULT_ICON_HEIGHT = 20;
    DEFAULT_ICON_WIDTH = 20;
    DEFAULT_ICON_FILL = "currentColor";
    icons = {
      bold,
      italic,
      code: code2,
    ...
    NgxEditorServiceConfig = class _NgxEditorServiceConfig {
      locals = {};
      icons = {};
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "18.2.2", ngImport: core_exports, type: _NgxEditorServiceConfig, deps: [], target: FactoryTarget.Injectable });
      static \u0275prov = \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "18.2.2", ngImport: core_exports, type: _NgxEditorServiceConfig, providedIn: "root" });
    };
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "18.2.2", ngImport: core_exports, type: NgxEditorServiceConfig, decorators: [{
      type: Injectable,
      args: [{
        providedIn: "root"
      }]
    }] });
    NgxEditorService = class _NgxEditorService {
      config;
      constructor(config) {
        this.config = config;
      }
      ...
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "18.2.2", ngImport: core_exports, type: _NgxEditorService, deps: [{ token: NgxEditorServiceConfig, optional: true }], target: FactoryTarget.Injectable });
      static \u0275prov = \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "18.2.2", ngImport: core_exports, type: _NgxEditorService, providedIn: "root" });
    };
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "18.2.2", ngImport: core_exports, type: NgxEditorService, decorators: [{
      type: Injectable,
      args: [{
        providedIn: "root"
      }]
    ...
    SanitizeHtmlPipe = class _SanitizeHtmlPipe {
      sanitizer;
      ...
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "18.2.2", ngImport: core_exports, type: _SanitizeHtmlPipe, deps: [{ token: DomSanitizer }], target: FactoryTarget.Pipe });
      static \u0275pipe = \u0275\u0275ngDeclarePipe({ minVersion: "14.0.0", version: "18.2.2", ngImport: core_exports, type: _SanitizeHtmlPipe, name: "sanitizeHtml" });
    };
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "18.2.2", ngImport: core_exports, type: SanitizeHtmlPipe, decorators: [{
      type: Pipe,
      args: [{
        name: "sanitizeHtml"
      }]
    }], ctorParameters: () => [{ type: DomSanitizer }] });
    ToggleCommandComponent = class _ToggleCommandComponent {
      ngxeService;
      menuService;
      toolbarItem;
      get name() {
      ...
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "18.2.2", ngImport: core_exports, type: _ToggleCommandComponent, deps: [{ token: NgxEditorService }, { token: MenuService }], target: FactoryTarget.Component });
      static \u0275cmp = \u0275\u0275ngDeclareComponent({ minVersion: "14.0.0", version: "18.2.2", type: _ToggleCommandComponent, selector: "ngx-toggle-command", inputs: { toolbarItem: "toolbarItem" }, ngImport: core_exports, template: '<button\n  type="button"\n  class="NgxEditor__MenuItem--Icon"\n  [class.NgxEditor__MenuItem--Active]="isActive"\n  [class.NgxEditor--Disabled]="disabled"\n  [disabled]="disabled"\n  [innerHTML]="html | sanitizeHtml"\n  (mousedown)="onMouseClick($event)"\n  (keydown.enter)="onKeydown()"\n  (keydown.space)="onKeydown()"\n  [title]="getTitle(name) | async"\n  [ariaLabel]="getTitle(name) | async"\n></button>\n', styles: [""], dependencies: [{ kind: "pipe", type: AsyncPipe, name: "async" }, { kind: "pipe", type: SanitizeHtmlPipe, name: "sanitizeHtml" }] });
    };
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "18.2.2", ngImport: core_exports, type: ToggleCommandComponent, decorators: [{
      type: Component,
    ...
    InsertCommandComponent = class _InsertCommandComponent {
      ngxeService;
      menuService;
      toolbarItem;
      get name() {
      ...
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "18.2.2", ngImport: core_exports, type: _InsertCommandComponent, deps: [{ token: NgxEditorService }, { token: MenuService }], target: FactoryTarget.Component });
      static \u0275cmp = \u0275\u0275ngDeclareComponent({ minVersion: "14.0.0", version: "18.2.2", type: _InsertCommandComponent, selector: "ngx-insert-command", inputs: { toolbarItem: "toolbarItem" }, ngImport: core_exports, template: '<button\n  class="NgxEditor__MenuItem--Icon"\n  [disabled]="disabled"\n  [class.NgxEditor--Disabled]="disabled"\n  [innerHTML]="html | sanitizeHtml"\n  (mousedown)="onMouseClick($event)"\n  (keydown.enter)="onKeydown()"\n  (keydown.space)="onKeydown()"\n  [title]="getTitle(name) | async"\n  [ariaLabel]="getTitle(name) | async"\n></button>\n', styles: [""], dependencies: [{ kind: "pipe", type: AsyncPipe, name: "async" }, { kind: "pipe", type: SanitizeHtmlPipe, name: "sanitizeHtml" }] });
    };
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "18.2.2", ngImport: core_exports, type: InsertCommandComponent, decorators: [{
      type: Component,
    ...
    LinkComponent = class _LinkComponent {
      el;
      ngxeService;
      menuService;
      ...
      setText = () => {
        const { state: { selection, doc: doc4 } } = this.editorView;
        const { empty: empty2, from: from2, to } = selection;
      ...
      update = (view) => {
        const { state } = view;
        this.isActive = Link2.isActive(state, { strict: false });
        this.canExecute = Link2.canExecute(state);
      };
      insertLink(e) {
        e.preventDefault();
        const { text: text2, href, openInNewTab } = this.form.getRawValue();
      ...
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "18.2.2", ngImport: core_exports, type: _LinkComponent, deps: [{ token: ElementRef }, { token: NgxEditorService }, { token: MenuService }], target: FactoryTarget.Component });
      static \u0275cmp = \u0275\u0275ngDeclareComponent({ minVersion: "16.1.0", version: "18.2.2", type: _LinkComponent, selector: "ngx-link", inputs: { options: ["options", "options", (value) => __spreadValues(__spreadValues({}, DEFAULT_LINK_OPTIONS), value)] }, host: { listeners: { "document:mousedown": "onDocumentClick($event)" } }, ngImport: core_exports, template: `<button
  type="button"
  class="NgxEditor__MenuItem--Icon"
...
`, styles: [""], dependencies: [{ kind: "directive", type: NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }, { kind: "directive", type: \u0275NgNoValidate, selector: "form:not([ngNoForm]):not([ngNativeValidate])" }, { kind: "directive", type: DefaultValueAccessor, selector: "input:not([type=checkbox])[formControlName],textarea[formControlName],input:not([type=checkbox])[formControl],textarea[formControl],input:not([type=checkbox])[ngModel],textarea[ngModel],[ngDefaultControl]" }, { kind: "directive", type: CheckboxControlValueAccessor, selector: "input[type=checkbox][formControlName],input[type=checkbox][formControl],input[type=checkbox][ngModel]" }, { kind: "directive", type: NgControlStatus, selector: "[formControlName],[ngModel],[formControl]" }, { kind: "directive", type: NgControlStatusGroup, selector: "[formGroupName],[formArrayName],[ngModelGroup],[formGroup],form:not([ngNoForm]),[ngForm]" }, { kind: "directive", type: FormGroupDirective, selector: "[formGroup]", inputs: ["formGroup"], outputs: ["ngSubmit"], exportAs: ["ngForm"] }, { kind: "directive", type: FormControlName, selector: "[formControlName]", inputs: ["formControlName", "disabled", "ngModel"], outputs: ["ngModelChange"] }, { kind: "pipe", type: AsyncPipe, name: "async" }, { kind: "pipe", type: SanitizeHtmlPipe, name: "sanitizeHtml" }] });
    };
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "18.2.2", ngImport: core_exports, type: LinkComponent, decorators: [{
      type: Component,
...
` }]
    }], ctorParameters: () => [{ type: ElementRef }, { type: NgxEditorService }, { type: MenuService }], propDecorators: { options: [{
      type: Input,
      args: [{
    ...
    DropdownComponent = class _DropdownComponent {
      ngxeService;
      menuService;
      el;
      editorView;
      ...
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "18.2.2", ngImport: core_exports, type: _DropdownComponent, deps: [{ token: NgxEditorService }, { token: MenuService }, { token: ElementRef }], target: FactoryTarget.Component });
      static \u0275cmp = \u0275\u0275ngDeclareComponent({ minVersion: "14.0.0", version: "18.2.2", type: _DropdownComponent, selector: "ngx-dropdown", inputs: { group: "group", items: "items" }, host: { listeners: { "document:mousedown": "onDocumentClick($event.target)" } }, ngImport: core_exports, template: `<button
  type="button"
...
`, styles: [""], dependencies: [{ kind: "directive", type: NgClass, selector: "[ngClass]", inputs: ["class", "ngClass"] }, { kind: "directive", type: NgForOf, selector: "[ngFor][ngForOf]", inputs: ["ngForOf", "ngForTrackBy", "ngForTemplate"] }, { kind: "directive", type: NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }, { kind: "pipe", type: AsyncPipe, name: "async" }] });
    };
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "18.2.2", ngImport: core_exports, type: DropdownComponent, decorators: [{
      type: Component,
...
` }]
    }], ctorParameters: () => [{ type: NgxEditorService }, { type: MenuService }, { type: ElementRef }], propDecorators: { group: [{
      type: Input
    }], items: [{
      type: Input
    }], onDocumentClick: [{
    ...
    ImageComponent = class _ImageComponent {
      el;
      ngxeService;
      menuService;
      showPopup = false;
      ...
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "18.2.2", ngImport: core_exports, type: _ImageComponent, deps: [{ token: ElementRef }, { token: NgxEditorService }, { token: MenuService }], target: FactoryTarget.Component });
      static \u0275cmp = \u0275\u0275ngDeclareComponent({ minVersion: "14.0.0", version: "18.2.2", type: _ImageComponent, selector: "ngx-image", host: { listeners: { "document:mousedown": "onDocumentClick($event)" } }, ngImport: core_exports, template: `<button
  type="button"
  class="NgxEditor__MenuItem--Icon"
  [class.NgxEditor__MenuItem--Active]="isActive || showPopup"
  [innerHTML]="icon | sanitizeHtml"
...
`, styles: [""], dependencies: [{ kind: "directive", type: NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }, { kind: "directive", type: \u0275NgNoValidate, selector: "form:not([ngNoForm]):not([ngNativeValidate])" }, { kind: "directive", type: DefaultValueAccessor, selector: "input:not([type=checkbox])[formControlName],textarea[formControlName],input:not([type=checkbox])[formControl],textarea[formControl],input:not([type=checkbox])[ngModel],textarea[ngModel],[ngDefaultControl]" }, { kind: "directive", type: NgControlStatus, selector: "[formControlName],[ngModel],[formControl]" }, { kind: "directive", type: NgControlStatusGroup, selector: "[formGroupName],[formArrayName],[ngModelGroup],[formGroup],form:not([ngNoForm]),[ngForm]" }, { kind: "directive", type: FormGroupDirective, selector: "[formGroup]", inputs: ["formGroup"], outputs: ["ngSubmit"], exportAs: ["ngForm"] }, { kind: "directive", type: FormControlName, selector: "[formControlName]", inputs: ["formControlName", "disabled", "ngModel"], outputs: ["ngModelChange"] }, { kind: "pipe", type: AsyncPipe, name: "async" }, { kind: "pipe", type: SanitizeHtmlPipe, name: "sanitizeHtml" }] });
    };
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "18.2.2", ngImport: core_exports, type: ImageComponent, decorators: [{
      type: Component,
...
` }]
    }], ctorParameters: () => [{ type: ElementRef }, { type: NgxEditorService }, { type: MenuService }], propDecorators: { onDocumentClick: [{
      type: HostListener,
      args: ["document:mousedown", ["$event"]]
    }] } });
    ColorPickerComponent = class _ColorPickerComponent {
      el;
      menuService;
      ngxeService;
      presets;
      ...
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "18.2.2", ngImport: core_exports, type: _ColorPickerComponent, deps: [{ token: ElementRef }, { token: MenuService }, { token: NgxEditorService }], target: FactoryTarget.Component });
      static \u0275cmp = \u0275\u0275ngDeclareComponent({ minVersion: "14.0.0", version: "18.2.2", type: _ColorPickerComponent, selector: "ngx-color-picker", inputs: { presets: "presets", type: "type" }, host: { listeners: { "document:mousedown": "onDocumentClick($event)" } }, ngImport: core_exports, template: `<button
  type="button"
  class="NgxEditor__MenuItem--Icon"
  [class.NgxEditor__MenuItem--Active]="isActive || showPopup"
  [class.NgxEditor--Disabled]="!canExecute"
...
`, styles: ['@charset "UTF-8";.NgxEditor__Popup{width:230px}.NgxEditor__ColorContainer{display:flex;justify-content:space-between}.NgxEditor__ColorContainer+.NgxEditor__ColorContainer{margin-top:5px}.NgxEditor__Color{border:none;outline:none;border-radius:6px;width:24px;height:24px;flex-shrink:0}.NgxEditor__Color:focus-visible{outline:1px solid var(--ngx-editor-focus-ring-color);outline-offset:1px}.NgxEditor__Color--Active:after{content:"\\2714";font-size:90%}.NgxEditor__MenuItem--Button{margin-top:5px}\n'] }]
    }], ctorParameters: () => [{ type: ElementRef }, { type: MenuService }, { type: NgxEditorService }], propDecorators: { presets: [{
      type: Input
    }], type: [{
      type: Input
    }], onDocumentClick: [{
    ...
    MenuComponent = class _MenuComponent {
      menuService;
      ...
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "18.2.2", ngImport: core_exports, type: _MenuComponent, deps: [{ token: MenuService }], target: FactoryTarget.Component });
      static \u0275cmp = \u0275\u0275ngDeclareComponent({ minVersion: "14.0.0", version: "18.2.2", type: _MenuComponent, selector: "ngx-editor-menu", inputs: { toolbar: "toolbar", colorPresets: "colorPresets", disabled: "disabled", editor: "editor", customMenuRef: "customMenuRef", dropdownPlacement: "dropdownPlacement" }, providers: [MenuService], ngImport: core_exports, template: `<div
...
`, styles: [""], dependencies: [{ kind: "directive", type: NgClass, selector: "[ngClass]", inputs: ["class", "ngClass"] }, { kind: "directive", type: NgForOf, selector: "[ngFor][ngForOf]", inputs: ["ngForOf", "ngForTrackBy", "ngForTemplate"] }, { kind: "directive", type: NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }, { kind: "directive", type: NgTemplateOutlet, selector: "[ngTemplateOutlet]", inputs: ["ngTemplateOutletContext", "ngTemplateOutlet", "ngTemplateOutletInjector"] }, { kind: "component", type: ToggleCommandComponent, selector: "ngx-toggle-command", inputs: ["toolbarItem"] }, { kind: "component", type: InsertCommandComponent, selector: "ngx-insert-command", inputs: ["toolbarItem"] }, { kind: "component", type: LinkComponent, selector: "ngx-link", inputs: ["options"] }, { kind: "component", type: DropdownComponent, selector: "ngx-dropdown", inputs: ["group", "items"] }, { kind: "component", type: ImageComponent, selector: "ngx-image" }, { kind: "component", type: ColorPickerComponent, selector: "ngx-color-picker", inputs: ["presets", "type"] }, { kind: "pipe", type: KeyValuePipe, name: "keyvalue" }] });
    ...
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "18.2.2", ngImport: core_exports, type: MenuComponent, decorators: [{
      type: Component,
...
` }]
    ...
    BubbleComponent = class _BubbleComponent {
      sanitizeHTML;
      ngxeService;
      ...
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "18.2.2", ngImport: core_exports, type: _BubbleComponent, deps: [{ token: SanitizeHtmlPipe }, { token: NgxEditorService }], target: FactoryTarget.Component });
      static \u0275cmp = \u0275\u0275ngDeclareComponent({ minVersion: "14.0.0", version: "18.2.2", type: _BubbleComponent, selector: "ngx-bubble", inputs: { editor: "editor" }, ngImport: core_exports, template: `<ng-container *ngFor="let toolbarItem of toolbar; let lastToolbarItem = last; trackBy: trackByIndex">
  <ng-container *ngFor="let item of toolbarItem; let lastItem = last; trackBy: trackByIndex">
    <button
      type="button"
...
`, styles: ["*,*:before,*:after{box-sizing:border-box}:host{display:flex;flex-wrap:wrap;background-color:var(--ngx-editor-bubble-bg-color);color:var(--ngx-editor-bubble-text-color);padding:5px;border-radius:4px}.NgxBubbleMenu__Icon{all:unset;appearance:none;height:var(--ngx-editor-icon-size);width:var(--ngx-editor-icon-size);transition:.2s ease-in-out;border-radius:var(--ngx-editor-menu-item-border-radius);display:flex;align-items:center;justify-content:center;color:#fff}.NgxBubbleMenu__Icon:hover{background-color:var(--ngx-editor-bubble-item-hover-color)}.NgxBubbleMenu__Icon+.NgxBubbleMenu__Icon{margin-left:5px}.NgxBubbleMenu__Icon.NgxBubbleMenu__Icon--Active{background-color:var(--ngx-editor-bubble-text-color);color:var(--ngx-editor-bubble-bg-color)}.NgxBubbleMenu__Seperator{border-left:1px solid var(--ngx-editor-seperator-color);margin:0 5px}\n"] }]
    ...
    FloatingMenuComponent = class _FloatingMenuComponent {
      el;
      constructor(el) {
        this.el = el;
      }
        ...
        return __async(this, null, function* () {
          ...
          const selectionElement = {
            getBoundingClientRect() {
              ...
              const { top: top2, left: left2 } = start;
          ...
          const { x: left, y: top } = yield computePosition2(selectionElement, bubbleEl, {
            placement: "top",
            middleware: [
              offset2(5),
              this.autoPlace && autoPlacement2({
                boundary: view.dom,
                padding: 5,
      ...
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "18.2.2", ngImport: core_exports, type: _FloatingMenuComponent, deps: [{ token: ElementRef }], target: FactoryTarget.Component });
      static \u0275cmp = \u0275\u0275ngDeclareComponent({ minVersion: "14.0.0", version: "18.2.2", type: _FloatingMenuComponent, selector: "ngx-editor-floating-menu", inputs: { editor: "editor", autoPlace: "autoPlace" }, host: { listeners: { "document:mousedown": "onMouseDown($event)", "document:keydown": "onKeyDown($event)", "document:mouseup": "onMouseUp($event)", "document:keyup": "onKeyUp($event)" }, properties: { "style": "this.display" } }, ngImport: core_exports, template: '<div #ref>\n  <ng-content></ng-content>\n</div>\n<ng-container *ngIf="ref.children.length === 0">\n  <ngx-bubble [editor]="editor"></ngx-bubble>\n</ng-container>\n', styles: ["*,*:before,*:after{box-sizing:border-box}:host{position:absolute;z-index:20;margin-bottom:5px;visibility:hidden;opacity:0}\n"], dependencies: [{ kind: "directive", type: NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }, { kind: "component", type: BubbleComponent, selector: "ngx-bubble", inputs: ["editor"] }] });
    };
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "18.2.2", ngImport: core_exports, type: FloatingMenuComponent, decorators: [{
      type: Component,
      args: [{ selector: "ngx-editor-floating-menu", template: '<div #ref>\n  <ng-content></ng-content>\n</div>\n<ng-container *ngIf="ref.children.length === 0">\n  <ngx-bubble [editor]="editor"></ngx-bubble>\n</ng-container>\n', styles: ["*,*:before,*:after{box-sizing:border-box}:host{position:absolute;z-index:20;margin-bottom:5px;visibility:hidden;opacity:0}\n"] }]
    }], ctorParameters: () => [{ type: ElementRef }], propDecorators: { display: [{
      type: HostBinding,
      args: ["style"]
    }], editor: [{
      type: Input
    ...
    MenuModule = class _MenuModule {
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "18.2.2", ngImport: core_exports, type: _MenuModule, deps: [], target: FactoryTarget.NgModule });
      static \u0275mod = \u0275\u0275ngDeclareNgModule({ minVersion: "14.0.0", version: "18.2.2", ngImport: core_exports, type: _MenuModule, declarations: [
        // pipes
        SanitizeHtmlPipe,
        // components
        MenuComponent,
      ...
      static \u0275inj = \u0275\u0275ngDeclareInjector({ minVersion: "12.0.0", version: "18.2.2", ngImport: core_exports, type: _MenuModule, providers: [
        SanitizeHtmlPipe
      ], imports: [
        CommonModule,
        ReactiveFormsModule
    ...
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "18.2.2", ngImport: core_exports, type: MenuModule, decorators: [{
      type: NgModule,
      args: [{
        imports: [
          CommonModule,
    ...
    NGX_EDITOR_CONFIG_TOKEN = new InjectionToken("NgxEditorConfig");
    defaultConfig = {
      locals: defaults,
      icons
    };
    NgxEditorModule = class _NgxEditorModule {
      ...
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "18.2.2", ngImport: core_exports, type: _NgxEditorModule, deps: [], target: FactoryTarget.NgModule });
      static \u0275mod = \u0275\u0275ngDeclareNgModule({ minVersion: "14.0.0", version: "18.2.2", ngImport: core_exports, type: _NgxEditorModule, declarations: [
        NgxEditorComponent,
        ImageViewComponent
      ], imports: [
        CommonModule,
      ...
      static \u0275inj = \u0275\u0275ngDeclareInjector({ minVersion: "12.0.0", version: "18.2.2", ngImport: core_exports, type: _NgxEditorModule, imports: [
        CommonModule,
        MenuModule
      ] });
    };
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "18.2.2", ngImport: core_exports, type: NgxEditorModule, decorators: [{
      type: NgModule,
      args: [{
        imports: [
          CommonModule,
    ...
    isDocEmpty = (doc4) => {
      ...
      const { childCount, firstChild } = doc4;
    ...
    EditorCommands = class {
      ...
      insertHTML(html) {
        const { selection, schema: schema2, tr } = this.state;
        const { from: from2, to } = selection;
    ...
    isMacOs = typeof navigator !== "undefined" ? /Mac/.test(navigator.platform) : false;
    blockQuoteRule = (nodeType) => {
      return wrappingInputRule(/^\s*>\s$/, nodeType);
    };
    orderedListRule = (nodeType) => {
    ...
    bulletListRule = (nodeType) => {
      return wrappingInputRule(/^\s*(?:[-+*])\s$/, nodeType);
    };
    codeBlockRule = (nodeType) => {
      return textblockTypeInputRule(/^```$/, nodeType);
    };
    headingRule = (nodeType, maxLevel) => {
    ...
    getKeyboardShortcuts = (schema2, options) => {
      const historyKeyMap = {};
    ...
    getDefaultPlugins = (schema2, options) => {
      const plugins = [];
      if (options.keyboardShortcuts) {
        plugins.push(...getKeyboardShortcuts(schema2, { history: options.history }));
      }
      if (options.history) {
    ...
    Editor = class {
      ...
      createEditor() {
        const { options, schema: schema2 } = this;
        const { content = null, nodeViews } = options;
        const { history: history2 = true, keyboardShortcuts = true, inputRules: inputRules2 = true } = options;
...
//# sourceMappingURL=chunk-BWQRL5BR.js.map
