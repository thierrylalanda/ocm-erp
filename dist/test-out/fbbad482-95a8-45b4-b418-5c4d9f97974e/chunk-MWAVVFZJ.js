...
var rt, st2, nt, F2, xe, be, _e, g3, $2, v2, at, N, k3, ne, ie, rr, E2, ue, b3, S2;
    ...
    BaseComponent = class _BaseComponent {
      ...
      _loadThemeStyles() {
        ...
        if (!S2.isStyleNameLoaded(this.componentStyle?.name) && this.componentStyle?.name) {
          const { css: css3, style: style2 } = this.componentStyle?.getComponentTheme?.() || {};
          this.componentStyle?.load(css3, __spreadValues({ name: `${this.componentStyle?.name}-variables` }, this.styleOptions));
      ...
      _loadScopedThemeStyles(preset) {
        const { css: css3 } = this.componentStyle?.getPresetTheme?.(preset, `[${this.attrSelector}]`) || {};
...
//# sourceMappingURL=chunk-MWAVVFZJ.js.map
