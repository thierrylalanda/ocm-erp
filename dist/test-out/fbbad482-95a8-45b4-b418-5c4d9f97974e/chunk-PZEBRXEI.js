...
var __assign, lGEvents, lightGalleryCoreSettings, lgQuery, defaultDynamicOptions, utils, lgId, LightGallery, lightgallery_es5_default;
var init_lightgallery_es5 = __esm({
  "node_modules/lightgallery/lightgallery.es5.js"() {
    ...
    lightgallery_es5_default = lightGallery;
  }
});

// node_modules/lightgallery/angular/fesm2022/lightgallery-angular.mjs
var _LightgalleryService, LightgalleryService, LgMethods, _LightgalleryComponent, LightgalleryComponent, _LightgalleryModule, LightgalleryModule;
var init_lightgallery_angular = __esm({
  "node_modules/lightgallery/angular/fesm2022/lightgallery-angular.mjs"() {
    "use strict";
    init_core();
    init_core();
    init_lightgallery_es5();
    _LightgalleryService = class _LightgalleryService {
      constructor() {
      }
    };
    _LightgalleryService.\u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "16.2.12", ngImport: core_exports, type: _LightgalleryService, deps: [], target: FactoryTarget.Injectable });
    _LightgalleryService.\u0275prov = \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "16.2.12", ngImport: core_exports, type: _LightgalleryService, providedIn: "root" });
    LightgalleryService = _LightgalleryService;
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.2.12", ngImport: core_exports, type: LightgalleryService, decorators: [{
      type: Injectable,
      args: [{
        providedIn: "root"
      }]
    ...
    _LightgalleryComponent = class _LightgalleryComponent {
    ...
    _LightgalleryComponent.\u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "16.2.12", ngImport: core_exports, type: _LightgalleryComponent, deps: [{ token: ElementRef }], target: FactoryTarget.Component });
    _LightgalleryComponent.\u0275cmp = \u0275\u0275ngDeclareComponent({ minVersion: "14.0.0", version: "16.2.12", type: _LightgalleryComponent, selector: "lightgallery", inputs: { settings: "settings", onAfterAppendSlide: "onAfterAppendSlide", onInit: "onInit", onHasVideo: "onHasVideo", onContainerResize: "onContainerResize", onAfterAppendSubHtml: "onAfterAppendSubHtml", onBeforeOpen: "onBeforeOpen", onAfterOpen: "onAfterOpen", onSlideItemLoad: "onSlideItemLoad", onBeforeSlide: "onBeforeSlide", onAfterSlide: "onAfterSlide", onPosterClick: "onPosterClick", onDragStart: "onDragStart", onDragMove: "onDragMove", onDragEnd: "onDragEnd", onBeforeNextSlide: "onBeforeNextSlide", onBeforePrevSlide: "onBeforePrevSlide", onBeforeClose: "onBeforeClose", onAfterClose: "onAfterClose", onRotateLeft: "onRotateLeft", onRotateRight: "onRotateRight", onFlipHorizontal: "onFlipHorizontal", onFlipVertical: "onFlipVertical" }, ngImport: core_exports, template: "<ng-content></ng-content>", isInline: true });
    LightgalleryComponent = _LightgalleryComponent;
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.2.12", ngImport: core_exports, type: LightgalleryComponent, decorators: [{
      type: Component,
    ...
    _LightgalleryModule = class _LightgalleryModule {
    };
    _LightgalleryModule.\u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "16.2.12", ngImport: core_exports, type: _LightgalleryModule, deps: [], target: FactoryTarget.NgModule });
    _LightgalleryModule.\u0275mod = \u0275\u0275ngDeclareNgModule({ minVersion: "14.0.0", version: "16.2.12", ngImport: core_exports, type: _LightgalleryModule, declarations: [LightgalleryComponent], exports: [LightgalleryComponent] });
    _LightgalleryModule.\u0275inj = \u0275\u0275ngDeclareInjector({ minVersion: "12.0.0", version: "16.2.12", ngImport: core_exports, type: _LightgalleryModule });
    LightgalleryModule = _LightgalleryModule;
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.2.12", ngImport: core_exports, type: LightgalleryModule, decorators: [{
      type: NgModule,
      args: [{
...
lightgallery/lightgallery.es5.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=chunk-PZEBRXEI.js.map
