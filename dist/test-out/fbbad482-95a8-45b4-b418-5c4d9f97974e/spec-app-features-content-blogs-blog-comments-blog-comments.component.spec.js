...
var init_blog_comments_component3 = __esm({
  "src/app/features/content/blogs/blog-comments/blog-comments.component.ts"() {
    ...
    init_date_range_picker_component();
    init_forms();
    BlogCommentsComponent = class BlogCommentsComponent2 {
      data;
      router;
      pagination;
      routes = routes;
    ...
    BlogCommentsComponent = __decorate([
      Component({
        ...
        template: blog_comments_component_default,
        styles: [blog_comments_component_default2]
      })
    ], BlogCommentsComponent);
  }
});

// src/app/features/content/blogs/blog-comments/blog-comments.component.spec.ts
var require_blog_comments_component_spec = __commonJS({
  "src/app/features/content/blogs/blog-comments/blog-comments.component.spec.ts"(exports) {
    init_testing();
    init_blog_comments_component3();
...
export default require_blog_comments_component_spec();
//# sourceMappingURL=spec-app-features-content-blogs-blog-comments-blog-comments.component.spec.js.map
