...
var init_countries_component3 = __esm({
  "src/app/features/content/location/countries/countries.component.ts"() {
    ...
    init_custom_pagination_component();
    init_forms();
    CountriesComponent = class CountriesComponent2 {
      data;
      router;
      pagination;
      routes = routes;
    ...
    CountriesComponent = __decorate([
      Component({
        ...
        template: countries_component_default,
        styles: [countries_component_default2]
      })
    ], CountriesComponent);
  }
});

// src/app/features/content/location/countries/countries.component.spec.ts
var require_countries_component_spec = __commonJS({
  "src/app/features/content/location/countries/countries.component.spec.ts"(exports) {
    init_testing();
    init_countries_component3();
...
export default require_countries_component_spec();
//# sourceMappingURL=spec-app-features-content-location-countries-countries.component.spec.js.map
