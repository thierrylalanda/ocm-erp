...
var init_states_component3 = __esm({
  "src/app/features/content/location/states/states.component.ts"() {
    ...
    init_forms();
    init_custom_pagination_component();
    StatesComponent = class StatesComponent2 {
      data;
      router;
      pagination;
      routes = routes;
    ...
    StatesComponent = __decorate([
      Component({
        ...
        template: states_component_default,
        styles: [states_component_default2]
      })
    ], StatesComponent);
  }
});

// src/app/features/content/location/states/states.component.spec.ts
var require_states_component_spec = __commonJS({
  "src/app/features/content/location/states/states.component.spec.ts"(exports) {
    init_testing();
    init_states_component3();
...
export default require_states_component_spec();
//# sourceMappingURL=spec-app-features-content-location-states-states.component.spec.js.map
