...
// angular:jit:template:src/app/features/content/pages/pages.component.html
var pages_component_default;
var init_pages_component = __esm({
  "angular:jit:template:src/app/features/content/pages/pages.component.html"() {
    pages_component_default = `            <!-- Start Content -->
...
// angular:jit:style:src/app/features/content/pages/pages.component.scss
var pages_component_default2;
var init_pages_component2 = __esm({
  "angular:jit:style:src/app/features/content/pages/pages.component.scss"() {
    pages_component_default2 = "/* src/app/features/content/pages/pages.component.scss */\n/*# sourceMappingURL=pages.component.css.map */\n";
  }
});

// src/app/features/content/pages/pages.component.ts
var PagesComponent;
var init_pages_component3 = __esm({
  "src/app/features/content/pages/pages.component.ts"() {
    "use strict";
    init_tslib_es6();
    init_pages_component();
    init_pages_component2();
    init_core();
    init_sort();
    init_table();
    init_router();
    ...
    init_custom_pagination_component();
    init_forms();
    PagesComponent = class PagesComponent2 {
      data;
      router;
      pagination;
      routes = routes;
    ...
    PagesComponent = __decorate([
      Component({
        ...
        template: pages_component_default,
        styles: [pages_component_default2]
      })
    ], PagesComponent);
  }
});

// src/app/features/content/pages/pages.component.spec.ts
var require_pages_component_spec = __commonJS({
  "src/app/features/content/pages/pages.component.spec.ts"(exports) {
    init_testing();
    init_pages_component3();
...
export default require_pages_component_spec();
//# sourceMappingURL=spec-app-features-content-pages-pages.component.spec.js.map
