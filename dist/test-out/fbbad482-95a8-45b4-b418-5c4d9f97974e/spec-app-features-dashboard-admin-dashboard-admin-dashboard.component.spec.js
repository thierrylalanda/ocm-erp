...
// angular:jit:template:src/app/features/dashboard/admin-dashboard/admin-dashboard.component.html
var admin_dashboard_component_default;
var init_admin_dashboard_component = __esm({
  "angular:jit:template:src/app/features/dashboard/admin-dashboard/admin-dashboard.component.html"() {
    admin_dashboard_component_default = `<!-- Start Breadcrumb -->
...
// angular:jit:style:src/app/features/dashboard/admin-dashboard/admin-dashboard.component.scss
var admin_dashboard_component_default2;
var init_admin_dashboard_component2 = __esm({
  "angular:jit:style:src/app/features/dashboard/admin-dashboard/admin-dashboard.component.scss"() {
    admin_dashboard_component_default2 = "/* src/app/features/dashboard/admin-dashboard/admin-dashboard.component.scss */\n/*# sourceMappingURL=admin-dashboard.component.css.map */\n";
  }
});

// src/app/core/directives/has-permissions.directive.ts
var HasPermissionsDirective;
var init_has_permissions_directive = __esm({
  "src/app/core/directives/has-permissions.directive.ts"() {
    "use strict";
    init_tslib_es6();
    init_core();
    init_permission_service();
    HasPermissionsDirective = class HasPermissionsDirective2 {
      tpl;
      vcr;
      permService;
      required = [];
      ...
      static propDecorators = {
        hasPermissions: [{ type: Input }],
        hasPermissionsMode: [{ type: Input }]
      };
    };
    HasPermissionsDirective = __decorate([
      Directive({
...
var init_admin_dashboard_component3 = __esm({
  "src/app/features/dashboard/admin-dashboard/admin-dashboard.component.ts"() {
    "use strict";
    init_tslib_es6();
    init_admin_dashboard_component();
    init_admin_dashboard_component2();
    init_core();
    init_core_index();
    init_ng_apexcharts();
    init_common();
    init_router();
    init_date_range_picker_component();
    init_has_permissions_directive();
    AdminDashboardComponent = class AdminDashboardComponent2 {
      routes = routes;
      chart;
      revenueChart;
      invoiceIncome;
    ...
    AdminDashboardComponent = __decorate([
      Component({
        ...
        template: admin_dashboard_component_default,
        imports: [
          CommonModule,
          NgApexchartsModule,
          RouterLink,
        ...
        styles: [admin_dashboard_component_default2]
      })
    ], AdminDashboardComponent);
  }
});

// src/app/features/dashboard/admin-dashboard/admin-dashboard.component.spec.ts
var require_admin_dashboard_component_spec = __commonJS({
  "src/app/features/dashboard/admin-dashboard/admin-dashboard.component.spec.ts"(exports) {
    init_testing();
    init_admin_dashboard_component3();
...
export default require_admin_dashboard_component_spec();
//# sourceMappingURL=spec-app-features-dashboard-admin-dashboard-admin-dashboard.component.spec.js.map
