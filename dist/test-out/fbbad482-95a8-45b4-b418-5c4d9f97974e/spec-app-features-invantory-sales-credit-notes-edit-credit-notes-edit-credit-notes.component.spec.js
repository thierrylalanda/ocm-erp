...
// angular:jit:template:src/app/features/invantory-sales/credit-notes/edit-credit-notes/edit-credit-notes.component.html
var edit_credit_notes_component_default;
var init_edit_credit_notes_component = __esm({
  "angular:jit:template:src/app/features/invantory-sales/credit-notes/edit-credit-notes/edit-credit-notes.component.html"() {
    edit_credit_notes_component_default = `<!-- start row -->
<div class="row">
...
// angular:jit:style:src/app/features/invantory-sales/credit-notes/edit-credit-notes/edit-credit-notes.component.scss
var edit_credit_notes_component_default2;
var init_edit_credit_notes_component2 = __esm({
  "angular:jit:style:src/app/features/invantory-sales/credit-notes/edit-credit-notes/edit-credit-notes.component.scss"() {
    edit_credit_notes_component_default2 = "/* src/app/features/invantory-sales/credit-notes/edit-credit-notes/edit-credit-notes.component.scss */\n/*# sourceMappingURL=edit-credit-notes.component.css.map */\n";
  }
});

// src/app/features/invantory-sales/credit-notes/edit-credit-notes/edit-credit-notes.component.ts
var EditCreditNotesComponent;
var init_edit_credit_notes_component3 = __esm({
  "src/app/features/invantory-sales/credit-notes/edit-credit-notes/edit-credit-notes.component.ts"() {
    "use strict";
    init_tslib_es6();
    init_edit_credit_notes_component();
    init_edit_credit_notes_component2();
    init_core();
    init_router();
    init_core_index();
    init_select();
    init_common();
    init_ngx_bootstrap_datepicker();
    EditCreditNotesComponent = class EditCreditNotesComponent2 {
      router;
      routes = routes;
      formData = [];
      trash = false;
    ...
    EditCreditNotesComponent = __decorate([
      Component({
        selector: "app-edit-credit-notes",
        imports: [CommonModule, MatSelectModule, RouterLink, BsDatepickerModule],
        template: edit_credit_notes_component_default,
        styles: [edit_credit_notes_component_default2]
      })
    ], EditCreditNotesComponent);
  }
});

// src/app/features/invantory-sales/credit-notes/edit-credit-notes/edit-credit-notes.component.spec.ts
var require_edit_credit_notes_component_spec = __commonJS({
  "src/app/features/invantory-sales/credit-notes/edit-credit-notes/edit-credit-notes.component.spec.ts"(exports) {
    init_testing();
    init_edit_credit_notes_component3();
...
export default require_edit_credit_notes_component_spec();
//# sourceMappingURL=spec-app-features-invantory-sales-credit-notes-edit-credit-notes-edit-credit-notes.component.spec.js.map
