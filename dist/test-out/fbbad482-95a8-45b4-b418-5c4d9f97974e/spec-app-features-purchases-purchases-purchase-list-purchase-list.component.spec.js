...
// angular:jit:template:src/app/features/purchases/purchases/purchase-list/purchase-list.component.html
var purchase_list_component_default;
var init_purchase_list_component = __esm({
  "angular:jit:template:src/app/features/purchases/purchases/purchase-list/purchase-list.component.html"() {
    purchase_list_component_default = `			<!-- Start Container -->
...
// angular:jit:style:src/app/features/purchases/purchases/purchase-list/purchase-list.component.scss
var purchase_list_component_default2;
var init_purchase_list_component2 = __esm({
  "angular:jit:style:src/app/features/purchases/purchases/purchase-list/purchase-list.component.scss"() {
    purchase_list_component_default2 = "/* src/app/features/purchases/purchases/purchase-list/purchase-list.component.scss */\n/*# sourceMappingURL=purchase-list.component.css.map */\n";
  }
});

// src/app/features/purchases/purchases/purchase-list/purchase-list.component.ts
var PurchaseListComponent;
var init_purchase_list_component3 = __esm({
  "src/app/features/purchases/purchases/purchase-list/purchase-list.component.ts"() {
    "use strict";
    init_tslib_es6();
    init_purchase_list_component();
    init_purchase_list_component2();
    init_core();
    init_sort();
    init_table();
    init_router();
    ...
    init_forms();
    init_custom_pagination_component();
    PurchaseListComponent = class PurchaseListComponent2 {
      data;
      router;
      pagination;
      routes = routes;
    ...
    PurchaseListComponent = __decorate([
      Component({
        ...
        template: purchase_list_component_default,
        styles: [purchase_list_component_default2]
      })
    ], PurchaseListComponent);
  }
});

// src/app/features/purchases/purchases/purchase-list/purchase-list.component.spec.ts
var require_purchase_list_component_spec = __commonJS({
  "src/app/features/purchases/purchases/purchase-list/purchase-list.component.spec.ts"(exports) {
    init_testing();
    init_purchase_list_component3();
...
export default require_purchase_list_component_spec();
//# sourceMappingURL=spec-app-features-purchases-purchases-purchase-list-purchase-list.component.spec.js.map
