...
// angular:jit:template:src/app/features/reports/accounting-report/account-statement/account-statement.component.html
var account_statement_component_default;
var init_account_statement_component = __esm({
  "angular:jit:template:src/app/features/reports/accounting-report/account-statement/account-statement.component.html"() {
    account_statement_component_default = `<div class="content-two">
...
// angular:jit:style:src/app/features/reports/accounting-report/account-statement/account-statement.component.scss
var account_statement_component_default2;
var init_account_statement_component2 = __esm({
  "angular:jit:style:src/app/features/reports/accounting-report/account-statement/account-statement.component.scss"() {
    account_statement_component_default2 = "/* src/app/features/reports/accounting-report/account-statement/account-statement.component.scss */\n/*# sourceMappingURL=account-statement.component.css.map */\n";
  }
});

// src/app/features/reports/accounting-report/account-statement/account-statement.component.ts
var AccountStatementComponent;
var init_account_statement_component3 = __esm({
  "src/app/features/reports/accounting-report/account-statement/account-statement.component.ts"() {
    "use strict";
    init_tslib_es6();
    init_account_statement_component();
    init_account_statement_component2();
    init_core();
    init_sort();
    init_table();
    init_router();
    ...
    init_date_range_picker_2_component();
    init_slider();
    AccountStatementComponent = class AccountStatementComponent2 {
      data;
      router;
      pagination;
      routes = routes;
    ...
    AccountStatementComponent = __decorate([
      Component({
        ...
        template: account_statement_component_default,
        styles: [account_statement_component_default2]
      })
    ], AccountStatementComponent);
  }
});

// src/app/features/reports/accounting-report/account-statement/account-statement.component.spec.ts
var require_account_statement_component_spec = __commonJS({
  "src/app/features/reports/accounting-report/account-statement/account-statement.component.spec.ts"(exports) {
    init_testing();
    init_account_statement_component3();
...
export default require_account_statement_component_spec();
//# sourceMappingURL=spec-app-features-reports-accounting-report-account-statement-account-statement.component.spec.js.map
