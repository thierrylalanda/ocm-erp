...
var init_income_report_component3 = __esm({
  "src/app/features/reports/accounting-report/income-report/income-report.component.ts"() {
    ...
    init_date_range_picker_component();
    init_slider();
    IncomeReportComponent = class IncomeReportComponent2 {
      data;
      router;
      pagination;
      routes = routes;
    ...
    IncomeReportComponent = __decorate([
      Component({
        ...
        template: income_report_component_default,
        styles: [income_report_component_default2]
      })
    ], IncomeReportComponent);
  }
});

// src/app/features/reports/accounting-report/income-report/income-report.component.spec.ts
var require_income_report_component_spec = __commonJS({
  "src/app/features/reports/accounting-report/income-report/income-report.component.spec.ts"(exports) {
    init_testing();
    init_income_report_component3();
...
export default require_income_report_component_spec();
//# sourceMappingURL=spec-app-features-reports-accounting-report-income-report-income-report.component.spec.js.map
