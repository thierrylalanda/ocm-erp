...
// angular:jit:template:src/app/features/reports/finance-reports/tax-report/tax-report.component.html
var tax_report_component_default;
var init_tax_report_component = __esm({
  "angular:jit:template:src/app/features/reports/finance-reports/tax-report/tax-report.component.html"() {
    tax_report_component_default = `            <!-- Start Content -->
...
// angular:jit:style:src/app/features/reports/finance-reports/tax-report/tax-report.component.scss
var tax_report_component_default2;
var init_tax_report_component2 = __esm({
  "angular:jit:style:src/app/features/reports/finance-reports/tax-report/tax-report.component.scss"() {
    tax_report_component_default2 = "/* src/app/features/reports/finance-reports/tax-report/tax-report.component.scss */\n/*# sourceMappingURL=tax-report.component.css.map */\n";
  }
});

// src/app/features/reports/finance-reports/tax-report/tax-report.component.ts
var TaxReportComponent;
var init_tax_report_component3 = __esm({
  "src/app/features/reports/finance-reports/tax-report/tax-report.component.ts"() {
    "use strict";
    init_tslib_es6();
    init_tax_report_component();
    init_tax_report_component2();
    init_core();
    init_sort();
    init_table();
    init_router();
    ...
    init_date_range_picker_component();
    init_date_range_picker_2_component();
    TaxReportComponent = class TaxReportComponent2 {
      data;
      router;
      pagination;
      routes = routes;
    ...
    TaxReportComponent = __decorate([
      Component({
        ...
        template: tax_report_component_default,
        styles: [tax_report_component_default2]
      })
    ], TaxReportComponent);
  }
});

// src/app/features/reports/finance-reports/tax-report/tax-report.component.spec.ts
var require_tax_report_component_spec = __commonJS({
  "src/app/features/reports/finance-reports/tax-report/tax-report.component.spec.ts"(exports) {
    init_testing();
    init_tax_report_component3();
...
export default require_tax_report_component_spec();
//# sourceMappingURL=spec-app-features-reports-finance-reports-tax-report-tax-report.component.spec.js.map
