...
// angular:jit:template:src/app/features/reports/item-report/best-seller/best-seller.component.html
var best_seller_component_default;
var init_best_seller_component = __esm({
  "angular:jit:template:src/app/features/reports/item-report/best-seller/best-seller.component.html"() {
    best_seller_component_default = `			<!-- Start Content -->
...
// angular:jit:style:src/app/features/reports/item-report/best-seller/best-seller.component.scss
var best_seller_component_default2;
var init_best_seller_component2 = __esm({
  "angular:jit:style:src/app/features/reports/item-report/best-seller/best-seller.component.scss"() {
    best_seller_component_default2 = "/* src/app/features/reports/item-report/best-seller/best-seller.component.scss */\n/*# sourceMappingURL=best-seller.component.css.map */\n";
  }
});

// src/app/features/reports/item-report/best-seller/best-seller.component.ts
var BestSellerComponent;
var init_best_seller_component3 = __esm({
  "src/app/features/reports/item-report/best-seller/best-seller.component.ts"() {
    "use strict";
    init_tslib_es6();
    init_best_seller_component();
    init_best_seller_component2();
    init_core();
    init_sort();
    init_table();
    init_router();
    ...
    init_date_range_picker_2_component();
    init_slider();
    BestSellerComponent = class BestSellerComponent2 {
      data;
      router;
      pagination;
      routes = routes;
    ...
    BestSellerComponent = __decorate([
      Component({
        ...
        template: best_seller_component_default,
        styles: [best_seller_component_default2]
      })
    ], BestSellerComponent);
  }
});

// src/app/features/reports/item-report/best-seller/best-seller.component.spec.ts
var require_best_seller_component_spec = __commonJS({
  "src/app/features/reports/item-report/best-seller/best-seller.component.spec.ts"(exports) {
    init_testing();
    init_best_seller_component3();
...
export default require_best_seller_component_spec();
//# sourceMappingURL=spec-app-features-reports-item-report-best-seller-best-seller.component.spec.js.map
