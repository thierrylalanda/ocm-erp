...
// angular:jit:template:src/app/features/reports/item-report/inventory-report/inventory-report.component.html
var inventory_report_component_default;
var init_inventory_report_component = __esm({
  "angular:jit:template:src/app/features/reports/item-report/inventory-report/inventory-report.component.html"() {
    inventory_report_component_default = `			<!-- Start Content -->
...
// angular:jit:style:src/app/features/reports/item-report/inventory-report/inventory-report.component.scss
var inventory_report_component_default2;
var init_inventory_report_component2 = __esm({
  "angular:jit:style:src/app/features/reports/item-report/inventory-report/inventory-report.component.scss"() {
    inventory_report_component_default2 = "/* src/app/features/reports/item-report/inventory-report/inventory-report.component.scss */\n/*# sourceMappingURL=inventory-report.component.css.map */\n";
  }
});

// src/app/features/reports/item-report/inventory-report/inventory-report.component.ts
var InventoryReportComponent;
var init_inventory_report_component3 = __esm({
  "src/app/features/reports/item-report/inventory-report/inventory-report.component.ts"() {
    "use strict";
    init_tslib_es6();
    init_inventory_report_component();
    init_inventory_report_component2();
    init_core();
    init_sort();
    init_table();
    init_router();
    ...
    init_date_range_picker_2_component();
    init_slider();
    InventoryReportComponent = class InventoryReportComponent2 {
      data;
      router;
      pagination;
      routes = routes;
    ...
    InventoryReportComponent = __decorate([
      Component({
        ...
        template: inventory_report_component_default,
        styles: [inventory_report_component_default2]
      })
    ], InventoryReportComponent);
  }
});

// src/app/features/reports/item-report/inventory-report/inventory-report.component.spec.ts
var require_inventory_report_component_spec = __commonJS({
  "src/app/features/reports/item-report/inventory-report/inventory-report.component.spec.ts"(exports) {
    init_testing();
    init_inventory_report_component3();
...
export default require_inventory_report_component_spec();
//# sourceMappingURL=spec-app-features-reports-item-report-inventory-report-inventory-report.component.spec.js.map
