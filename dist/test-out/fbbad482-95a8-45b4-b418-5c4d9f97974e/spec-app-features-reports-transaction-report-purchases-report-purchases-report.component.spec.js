...
// angular:jit:template:src/app/features/reports/transaction-report/purchases-report/purchases-report.component.html
var purchases_report_component_default;
var init_purchases_report_component = __esm({
  "angular:jit:template:src/app/features/reports/transaction-report/purchases-report/purchases-report.component.html"() {
    purchases_report_component_default = `			<!-- Start Content -->
...
// angular:jit:style:src/app/features/reports/transaction-report/purchases-report/purchases-report.component.scss
var purchases_report_component_default2;
var init_purchases_report_component2 = __esm({
  "angular:jit:style:src/app/features/reports/transaction-report/purchases-report/purchases-report.component.scss"() {
    purchases_report_component_default2 = "/* src/app/features/reports/transaction-report/purchases-report/purchases-report.component.scss */\n/*# sourceMappingURL=purchases-report.component.css.map */\n";
  }
});

// src/app/features/reports/transaction-report/purchases-report/purchases-report.component.ts
var PurchasesReportComponent;
var init_purchases_report_component3 = __esm({
  "src/app/features/reports/transaction-report/purchases-report/purchases-report.component.ts"() {
    "use strict";
    init_tslib_es6();
    init_purchases_report_component();
    init_purchases_report_component2();
    init_core();
    init_sort();
    init_table();
    init_router();
    ...
    init_date_range_picker_component();
    init_date_range_picker_2_component();
    PurchasesReportComponent = class PurchasesReportComponent2 {
      data;
      router;
      pagination;
      routes = routes;
    ...
    PurchasesReportComponent = __decorate([
      Component({
        ...
        template: purchases_report_component_default,
        styles: [purchases_report_component_default2]
      })
    ], PurchasesReportComponent);
  }
});

// src/app/features/reports/transaction-report/purchases-report/purchases-report.component.spec.ts
var require_purchases_report_component_spec = __commonJS({
  "src/app/features/reports/transaction-report/purchases-report/purchases-report.component.spec.ts"(exports) {
    init_testing();
    init_purchases_report_component3();
...
export default require_purchases_report_component_spec();
//# sourceMappingURL=spec-app-features-reports-transaction-report-purchases-report-purchases-report.component.spec.js.map
