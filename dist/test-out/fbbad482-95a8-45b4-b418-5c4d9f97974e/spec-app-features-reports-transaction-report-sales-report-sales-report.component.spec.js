...
// angular:jit:template:src/app/features/reports/transaction-report/sales-report/sales-report.component.html
var sales_report_component_default;
var init_sales_report_component = __esm({
  "angular:jit:template:src/app/features/reports/transaction-report/sales-report/sales-report.component.html"() {
    sales_report_component_default = `		<!-- Start Content -->
...
// angular:jit:style:src/app/features/reports/transaction-report/sales-report/sales-report.component.scss
var sales_report_component_default2;
var init_sales_report_component2 = __esm({
  "angular:jit:style:src/app/features/reports/transaction-report/sales-report/sales-report.component.scss"() {
    sales_report_component_default2 = "/* src/app/features/reports/transaction-report/sales-report/sales-report.component.scss */\n/*# sourceMappingURL=sales-report.component.css.map */\n";
  }
});

// src/app/features/reports/transaction-report/sales-report/sales-report.component.ts
var SalesReportComponent;
var init_sales_report_component3 = __esm({
  "src/app/features/reports/transaction-report/sales-report/sales-report.component.ts"() {
    "use strict";
    init_tslib_es6();
    init_sales_report_component();
    init_sales_report_component2();
    init_core();
    init_sort();
    init_table();
    init_router();
    ...
    init_select();
    init_date_range_picker_2_component();
    SalesReportComponent = class SalesReportComponent2 {
      data;
      router;
      pagination;
      routes = routes;
    ...
    SalesReportComponent = __decorate([
      Component({
        ...
        template: sales_report_component_default,
        styles: [sales_report_component_default2]
      })
    ], SalesReportComponent);
  }
});

// src/app/features/reports/transaction-report/sales-report/sales-report.component.spec.ts
var require_sales_report_component_spec = __commonJS({
  "src/app/features/reports/transaction-report/sales-report/sales-report.component.spec.ts"(exports) {
    init_testing();
    init_sales_report_component3();
...
export default require_sales_report_component_spec();
//# sourceMappingURL=spec-app-features-reports-transaction-report-sales-report-sales-report.component.spec.js.map
