...
// angular:jit:template:src/app/features/reports/user-reports/customers-report/customers-report.component.html
var customers_report_component_default;
var init_customers_report_component = __esm({
  "angular:jit:template:src/app/features/reports/user-reports/customers-report/customers-report.component.html"() {
    customers_report_component_default = `<div class="content-two">
...
// angular:jit:style:src/app/features/reports/user-reports/customers-report/customers-report.component.scss
var customers_report_component_default2;
var init_customers_report_component2 = __esm({
  "angular:jit:style:src/app/features/reports/user-reports/customers-report/customers-report.component.scss"() {
    customers_report_component_default2 = "/* src/app/features/reports/user-reports/customers-report/customers-report.component.scss */\n/*# sourceMappingURL=customers-report.component.css.map */\n";
  }
});

// src/app/features/reports/user-reports/customers-report/customers-report.component.ts
var CustomersReportComponent;
var init_customers_report_component3 = __esm({
  "src/app/features/reports/user-reports/customers-report/customers-report.component.ts"() {
    "use strict";
    init_tslib_es6();
    init_customers_report_component();
    init_customers_report_component2();
    init_core();
    init_sort();
    init_table();
    init_router();
    ...
    init_date_range_picker_component();
    init_date_range_picker_2_component();
    CustomersReportComponent = class CustomersReportComponent2 {
      data;
      router;
      pagination;
      routes = routes;
    ...
    CustomersReportComponent = __decorate([
      Component({
        ...
        template: customers_report_component_default,
        styles: [customers_report_component_default2]
      })
    ], CustomersReportComponent);
  }
});

// src/app/features/reports/user-reports/customers-report/customers-report.component.spec.ts
var require_customers_report_component_spec = __commonJS({
  "src/app/features/reports/user-reports/customers-report/customers-report.component.spec.ts"(exports) {
    init_testing();
    init_customers_report_component3();
...
export default require_customers_report_component_spec();
//# sourceMappingURL=spec-app-features-reports-user-reports-customers-report-customers-report.component.spec.js.map
