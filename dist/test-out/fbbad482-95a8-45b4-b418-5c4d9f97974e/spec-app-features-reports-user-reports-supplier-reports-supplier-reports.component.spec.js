...
// angular:jit:template:src/app/features/reports/user-reports/supplier-reports/supplier-reports.component.html
var supplier_reports_component_default;
var init_supplier_reports_component = __esm({
  "angular:jit:template:src/app/features/reports/user-reports/supplier-reports/supplier-reports.component.html"() {
    supplier_reports_component_default = `			<!-- Start Content -->
...
// angular:jit:style:src/app/features/reports/user-reports/supplier-reports/supplier-reports.component.scss
var supplier_reports_component_default2;
var init_supplier_reports_component2 = __esm({
  "angular:jit:style:src/app/features/reports/user-reports/supplier-reports/supplier-reports.component.scss"() {
    supplier_reports_component_default2 = "/* src/app/features/reports/user-reports/supplier-reports/supplier-reports.component.scss */\n/*# sourceMappingURL=supplier-reports.component.css.map */\n";
  }
});

// src/app/features/reports/user-reports/supplier-reports/supplier-reports.component.ts
var SupplierReportsComponent;
var init_supplier_reports_component3 = __esm({
  "src/app/features/reports/user-reports/supplier-reports/supplier-reports.component.ts"() {
    "use strict";
    init_tslib_es6();
    init_supplier_reports_component();
    init_supplier_reports_component2();
    init_core();
    init_sort();
    init_table();
    init_router();
    ...
    init_date_range_picker_component();
    init_date_range_picker_2_component();
    SupplierReportsComponent = class SupplierReportsComponent2 {
      data;
      router;
      pagination;
      routes = routes;
    ...
    SupplierReportsComponent = __decorate([
      Component({
        ...
        template: supplier_reports_component_default,
        styles: [supplier_reports_component_default2]
      })
    ], SupplierReportsComponent);
  }
});

// src/app/features/reports/user-reports/supplier-reports/supplier-reports.component.spec.ts
var require_supplier_reports_component_spec = __commonJS({
  "src/app/features/reports/user-reports/supplier-reports/supplier-reports.component.spec.ts"(exports) {
    init_testing();
    init_supplier_reports_component3();
...
export default require_supplier_reports_component_spec();
//# sourceMappingURL=spec-app-features-reports-user-reports-supplier-reports-supplier-reports.component.spec.js.map
