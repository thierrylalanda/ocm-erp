...
// angular:jit:template:src/app/features/ui-interface/base-ui/modals/modals.component.html
var modals_component_default;
var init_modals_component = __esm({
  "angular:jit:template:src/app/features/ui-interface/base-ui/modals/modals.component.html"() {
    modals_component_default = `			<!-- Start Content -->
      <div class="">
...
// angular:jit:style:src/app/features/ui-interface/base-ui/modals/modals.component.scss
var modals_component_default2;
var init_modals_component2 = __esm({
  "angular:jit:style:src/app/features/ui-interface/base-ui/modals/modals.component.scss"() {
    modals_component_default2 = "/* src/app/features/ui-interface/base-ui/modals/modals.component.scss */\n/*# sourceMappingURL=modals.component.css.map */\n";
  }
});

// src/app/features/ui-interface/base-ui/modals/modals.component.ts
var ModalsComponent;
var init_modals_component3 = __esm({
  "src/app/features/ui-interface/base-ui/modals/modals.component.ts"() {
    "use strict";
    init_tslib_es6();
    init_modals_component();
    init_modals_component2();
    init_core();
    init_common();
    init_core_index();
    init_router();
    ModalsComponent = class ModalsComponent2 {
      routes = routes;
    };
    ModalsComponent = __decorate([
      Component({
        selector: "app-modals",
        template: modals_component_default,
        imports: [CommonModule, RouterLink],
        styles: [modals_component_default2]
      })
    ], ModalsComponent);
  }
});

// src/app/features/ui-interface/base-ui/modals/modals.component.spec.ts
var require_modals_component_spec = __commonJS({
  "src/app/features/ui-interface/base-ui/modals/modals.component.spec.ts"(exports) {
    init_testing();
    init_modals_component3();
...
export default require_modals_component_spec();
//# sourceMappingURL=spec-app-features-ui-interface-base-ui-modals-modals.component.spec.js.map
