...
// angular:jit:template:src/app/modules/setting/presentation/pages/other-settings/system-update/system-update.component.html
...
// angular:jit:style:src/app/modules/setting/presentation/pages/other-settings/system-update/system-update.component.scss
var system_update_component_default2;
var init_system_update_component2 = __esm({
  "angular:jit:style:src/app/modules/setting/presentation/pages/other-settings/system-update/system-update.component.scss"() {
    system_update_component_default2 = "/* src/app/modules/setting/presentation/pages/other-settings/system-update/system-update.component.scss */\n/*# sourceMappingURL=system-update.component.css.map */\n";
  }
});
...
// src/app/modules/setting/presentation/pages/other-settings/system-update/system-update.component.spec.ts
var require_system_update_component_spec = __commonJS({
  "src/app/modules/setting/presentation/pages/other-settings/system-update/system-update.component.spec.ts"(exports) {
    init_testing();
...
//# sourceMappingURL=spec-app-modules-setting-presentation-pages-other-settings-system-update-system-update.component.spec.js.map
