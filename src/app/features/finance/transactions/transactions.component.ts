...
import { apiResultFormat, transaction } from '../../../../../src/app/core/models/models';
...
formatLabel(value: number): string {
  ...
  public tableDataCopy: transaction[] = [];
  public actualData: transaction[] = [];
  ...
  private getTableData(pageOption: pageSelection): void {
    this.data.getTransaction().subscribe((apiRes: apiResultFormat) => {
      ...
      this.dataSource = new MatTableDataSource<transaction>(this.actualData);
