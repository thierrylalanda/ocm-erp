...
import { apiResultFormat, creditnotes } from '../../../../../../src/app/core/models/models';
...
export class CreditNoteListComponent {
 ...
 initChecked=false;
 public pageSize = 10;
 public tableData: creditnotes[] = [];
 public tableDataCopy: creditnotes[] = [];
 public actualData: creditnotes[] = [];
 ...
 private getTableData(pageOption: pageSelection): void {
   this.data.getcreditnotes().subscribe((apiRes: apiResultFormat) => {
     ...
     this.dataSource = new MatTableDataSource<creditnotes>(this.actualData);
