...
@Component({
    ...
    imports: [MatSelectModule,DateRangePickerComponent,CustomPaginationComponent,MatSortModule,FormsModule,CommonModule]
})
...
routes = routes;
 ...
 initChecked=false;
 public pageSize = 10;
 public tableData: inventory[] = [];
 public tableDataCopy: inventory[] = [];
 public actualData: inventory[] = [];
 ...
 private getTableData(pageOption: pageSelection): void {
   this.data.getinventory().subscribe((apiRes: apiResultFormat) => {
     ...
     this.dataSource = new MatTableDataSource<inventory>(this.actualData);
