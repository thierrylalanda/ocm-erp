...
import { apiResultFormat, membershipAddon } from '../../../../../../src/app/core/models/models';
...
@Component({
  ...
  styleUrls: [ './membership-addons.component.scss']
})
...
initChecked=false;
public pageSize = 10;
public tableData: membershipAddon[] = [];
public tableDataCopy: membershipAddon[] = [];
public actualData: membershipAddon[] = [];
...
dataSource!: MatTableDataSource<membershipAddon>;
...
constructor(
  ...
  this.data.getMembershipAddons().subscribe((apiRes: apiResultFormat) => {
...
private getTableData(pageOption: pageSelection): void {
  this.data.getMembershipAddons().subscribe((apiRes: apiResultFormat) => {
    ...
    apiRes.data.map((res: membershipAddon, index: number) => {
    ...
    this.dataSource = new MatTableDataSource<membershipAddon>(this.actualData);
