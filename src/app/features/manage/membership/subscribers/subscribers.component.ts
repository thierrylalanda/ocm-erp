...
import { apiResultFormat, subscribers } from '../../../../../../src/app/core/models/models';
...
initChecked=false;
public pageSize = 10;
public tableData: subscribers[] = [];
public tableDataCopy: subscribers[] = [];
public actualData: subscribers[] = [];
...
private getTableData(pageOption: pageSelection): void {
  this.data.getSubscribers().subscribe((apiRes: apiResultFormat) => {
    ...
    this.dataSource = new MatTableDataSource<subscribers>(this.actualData);
