...
import { apiResultFormat, debitnotes } from '../../../../../../src/app/core/models/models';
...
@Component({
  ...
  imports:[DateRangePickerComponent,MatSliderModule,CommonModule,FormsModule,CustomPaginationComponent
...
initChecked=false;
public pageSize = 10;
public tableData: debitnotes[] = [];
public tableDataCopy: debitnotes[] = [];
public actualData: debitnotes[] = [];
...
private getTableData(pageOption: pageSelection): void {
  this.data.getdebitnotes().subscribe((apiRes: apiResultFormat) => {
    ...
    this.dataSource = new MatTableDataSource<debitnotes>(this.actualData);
