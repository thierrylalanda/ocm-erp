...
@Component({
  ...
  imports:[DateRangePickerComponent,CustomPaginationComponent,RouterLink,MatSortModule,
    CommonModule,FormsModule
  ],
  templateUrl: './purchases-order-list.component.html',
  styleUrls: [ './purchases-order-list.component.scss']
})
export class PurchasesOrderListComponent {
routes=routes
showFilter=false; 
