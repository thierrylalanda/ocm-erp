...
import { apiResultFormat, supplierPayment } from '../../../../../src/app/core/models/models';
...
@Component({
  ...
  imports:[MatSelectModule,DateRangePickerComponent,MatSliderModule
...
initChecked=false;
public pageSize = 10;
public tableData: supplierPayment[] = [];
public tableDataCopy: supplierPayment[] = [];
public actualData: supplierPayment[] = [];
...
constructor(
  ...
  this.data.getSupplierPayment().subscribe((apiRes: apiResultFormat) => {
...
private getTableData(pageOption: pageSelection): void {
  this.data.getSupplierPayment().subscribe((apiRes: apiResultFormat) => {
    ...
    apiRes.data.map((res: supplierPayment, index: number) => {
    ...
    this.dataSource = new MatTableDataSource<supplierPayment>(this.actualData);
