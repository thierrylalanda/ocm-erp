...
import { apiResultFormat, accountstatement } from '../../../../../../src/app/core/models/models';
...
export class AccountStatementComponent {
 routes=routes
  ...
  initChecked=false;
  public pageSize = 10;
  public tableData: accountstatement[] = [];
  public tableDataCopy: accountstatement[] = [];
  public actualData: accountstatement[] = [];
  ...
  private getTableData(pageOption: pageSelection): void {
    this.data.getAccountstatement().subscribe((apiRes: apiResultFormat) => {
      ...
      this.dataSource = new MatTableDataSource<accountstatement>(this.actualData);
