...
import { apiResultFormat, cashflow } from '../../../../../../src/app/core/models/models';
...
routes=routes
  ...
  initChecked=false;
  public pageSize = 10;
  public tableData: cashflow[] = [];
  public tableDataCopy: cashflow[] = [];
  public actualData: cashflow[] = [];
  ...
  private getTableData(pageOption: pageSelection): void {
    this.data.getCashflow().subscribe((apiRes: apiResultFormat) => {
      ...
      this.dataSource = new MatTableDataSource<cashflow>(this.actualData);
