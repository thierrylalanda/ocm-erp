...
import { apiResultFormat, incomereport } from '../../../../../../src/app/core/models/models';
...
@Component({
  ...
  imports: [CommonModule,FormsModule,CustomPaginationComponent,MatSortModule,
    DateRangePicker2Component,DateRangePickerComponent,MatSliderModule
  ],
...
routes=routes
  ...
  initChecked=false;
  public pageSize = 10;
  public tableData: incomereport[] = [];
  public tableDataCopy: incomereport[] = [];
  public actualData: incomereport[] = [];
  ...
  private getTableData(pageOption: pageSelection): void {
    this.data.getIncomereport().subscribe((apiRes: apiResultFormat) => {
      ...
      this.dataSource = new MatTableDataSource<incomereport>(this.actualData);
