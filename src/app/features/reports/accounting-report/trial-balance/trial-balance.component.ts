...
import { apiResultFormat, trialbalance } from '../../../../../../src/app/core/models/models';
...
@Component({
  ...
  imports: [CommonModule,FormsModule,CustomPaginationComponent,MatSortModule,
    NgApexchartsModule,DateRangePicker2Component,MatSliderModule
  ],
...
routes=routes
  ...
  initChecked=false;
  public pageSize = 10;
  public tableData: trialbalance[] = [];
  public tableDataCopy: trialbalance[] = [];
  public actualData: trialbalance[] = [];
  ...
  dataSource!: MatTableDataSource<trialbalance>;
  ...
  constructor(
    ...
    this.data.getTrialbalance().subscribe((apiRes: apiResultFormat) => {
  ...
  private getTableData(pageOption: pageSelection): void {
    this.data.getTrialbalance().subscribe((apiRes: apiResultFormat) => {
      ...
      apiRes.data.map((res: trialbalance, index: number) => {
      ...
      this.dataSource = new MatTableDataSource<trialbalance>(this.actualData);
