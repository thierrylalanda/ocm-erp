...
import { apiResultFormat, quotationReport } from '../../../../../../src/app/core/models/models';
...
isSelectedFilter(index:number){
  ...
  initChecked=false;
  public pageSize = 10;
  public tableData: quotationReport[] = [];
  public tableDataCopy: quotationReport[] = [];
  public actualData: quotationReport[] = [];
  ...
  constructor(
    ...
    this.data.getQuotationReport().subscribe((apiRes: apiResultFormat) => {
  ...
  private getTableData(pageOption: pageSelection): void {
    this.data.getQuotationReport().subscribe((apiRes: apiResultFormat) => {
      ...
      this.dataSource = new MatTableDataSource<quotationReport>(this.actualData);
