...
import { apiResultFormat, salesreport } from '../../../../../../src/app/core/models/models';
...
@Component({
  ...
  imports:[CommonModule,FormsModule,CustomPaginationComponent,MatSortModule,
    MatSliderModule,MatSelectModule,DateRangePicker2Component
  ],
...
isSelectedFilter(index:number){
  ...
  initChecked=false;
  public pageSize = 10;
  public tableData: salesreport[] = [];
  public tableDataCopy: salesreport[] = [];
  public actualData: salesreport[] = [];
  ...
  constructor(
    ...
    this.data.getSalesOrderReport().subscribe((apiRes: apiResultFormat) => {
  ...
  private getTableData(pageOption: pageSelection): void {
    this.data.getSalesOrderReport().subscribe((apiRes: apiResultFormat) => {
      ...
      this.dataSource = new MatTableDataSource<salesreport>(this.actualData);
