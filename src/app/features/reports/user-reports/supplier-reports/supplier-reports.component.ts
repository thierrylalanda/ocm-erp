...
import { apiResultFormat, suppliers } from '../../../../../../src/app/core/models/models';
...
@Component({
  ...
  imports:[CommonModule,FormsModule,CustomPaginationComponent,MatSortModule,
    MatSliderModule,DateRangePickerComponent,DateRangePicker2Component
  ],
...
export class SupplierReportsComponent {
  ...
  initChecked=false;
  public pageSize = 10;
  public tableData: suppliers[] = [];
  public tableDataCopy: suppliers[] = [];
  public actualData: suppliers[] = [];
  ...
  dataSource!: MatTableDataSource<suppliers>;
  ...
  private getTableData(pageOption: pageSelection): void {
    this.data.getSupplier().subscribe((apiRes: apiResultFormat) => {
      ...
      apiRes.data.map((res: suppliers, index: number) => {
      ...
      this.dataSource = new MatTableDataSource<suppliers>(this.actualData);
