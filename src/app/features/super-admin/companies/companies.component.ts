...
import { apiResultFormat, companies } from '../../../../../src/app/core/models/models';
...
export class CompaniesComponent {
 ...
 initChecked=false;
 public pageSize = 10;
 public tableData: companies[] = [];
 public tableDataCopy: companies[] = [];
 public actualData: companies[] = [];
 ...
 private getTableData(pageOption: pageSelection): void {
   this.data.getCompanies().subscribe((apiRes: apiResultFormat) => {
     ...
     this.dataSource = new MatTableDataSource<companies>(this.actualData);
