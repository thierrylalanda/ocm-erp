...
import { apiResultFormat, domain } from '../../../../../src/app/core/models/models';
...
export class DomainComponent {
  routes=routes
     ...
     initChecked=false;
     public pageSize = 10;
     public tableData: domain[] = [];
     public tableDataCopy: domain[] = [];
     public actualData: domain[] = [];
     ...
     private getTableData(pageOption: pageSelection): void {
       this.data.getDomain().subscribe((apiRes: apiResultFormat) => {
         ...
         this.dataSource = new MatTableDataSource<domain>(this.actualData);
