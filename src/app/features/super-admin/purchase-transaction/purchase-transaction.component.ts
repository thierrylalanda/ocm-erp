...
import { apiResultFormat, purchaseTransaction } from '../../../../../src/app/core/models/models';
...
routes=routes
   ...
   initChecked=false;
   public pageSize = 10;
   public tableData: purchaseTransaction[] = [];
   public tableDataCopy: purchaseTransaction[] = [];
   public actualData: purchaseTransaction[] = [];
   ...
   private getTableData(pageOption: pageSelection): void {
     this.data.getPurchaseTransaction().subscribe((apiRes: apiResultFormat) => {
       ...
       this.dataSource = new MatTableDataSource<purchaseTransaction>(this.actualData);
